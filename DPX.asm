...
L_CAN_Interrupt23:
;DPX.c,172 :: 		if(dEfiSense_calculateSpeed(firstInt)>=EFI_SENSE_MIN_SPEED)
	MOV	[W14+0], W10
...
L__CAN_Interrupt55:
;DPX.c,173 :: 		dControls_disableCentralSelector();
...
L_CAN_Interrupt25:
;DPX.c,177 :: 		dd_Indicator_setIntValueP(&ind_launch_control.base, fourthInt);
	MOV	[W14+6], W11
...
;DPX.c,185 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,192 :: 		case DAU_FR_DEBUG_ID:
L_CAN_Interrupt28:
;DPX.c,193 :: 		dd_Indicator_setIntCoupleValueP(&ind_dau_fr_board.base, (int)firstInt, (int)secondInt);
	MOV	[W14+2], W12
	MOV	[W14+0], W11
...
;DPX.c,194 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,195 :: 		case DAU_FL_DEBUG_ID:
L_CAN_Interrupt29:
;DPX.c,196 :: 		dd_Indicator_setIntCoupleValueP(&ind_dau_fl_board.base, (int)firstInt, (int)secondInt);
	MOV	[W14+2], W12
	MOV	[W14+0], W11
...
;DPX.c,197 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,198 :: 		case DAU_REAR_DEBUG_ID:
L_CAN_Interrupt30:
;DPX.c,199 :: 		dd_Indicator_setIntCoupleValueP(&ind_dau_r_board.base, (int)firstInt, (int)secondInt);
	MOV	[W14+2], W12
	MOV	[W14+0], W11
...
;DPX.c,200 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,205 :: 		case GCU_DEBUG_1_ID:
L_CAN_Interrupt31:
;DPX.c,206 :: 		dd_Indicator_setIntValueP(&ind_gcu_temp.base, (firstInt));
	MOV	[W14+0], W11
	MOV	#lo_addr(_ind_gcu_temp), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,207 :: 		dd_Indicator_setIntValueP(&ind_H2O_fans.base, (secondInt));
	MOV	[W14+2], W11
	MOV	#lo_addr(_ind_H2O_fans), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,208 :: 		dd_Indicator_setIntValueP(&ind_H2O_pump.base, (thirdInt));
	MOV	[W14+4], W11
	MOV	#lo_addr(_ind_H2O_pump), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,209 :: 		dd_Indicator_setIntValueP(&ind_fuel_pump.base, (fourthInt));
	MOV	[W14+6], W11
	MOV	#lo_addr(_ind_fuel_pump), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,210 :: 		break; //*/
	GOTO	L_CAN_Interrupt19
;DPX.c,211 :: 		case GCU_DEBUG_2_ID:
L_CAN_Interrupt32:
;DPX.c,212 :: 		dd_Indicator_setIntValueP(&ind_gear_motor.base, (firstInt));
	MOV	[W14+0], W11
	MOV	#lo_addr(_ind_gear_motor), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,213 :: 		dd_Indicator_setIntValueP(&ind_clutch.base, (secondInt));
	MOV	[W14+2], W11
	MOV	#lo_addr(_ind_clutch), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,214 :: 		dd_Indicator_setIntValueP(&ind_drs.base, (thirdInt));
	MOV	[W14+4], W11
	MOV	#lo_addr(_ind_drs), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,215 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,216 :: 		case DCU_DEBUG_ID:
L_CAN_Interrupt33:
;DPX.c,217 :: 		dd_Indicator_setIntCoupleValueP(&ind_dcu_board.base,(int)firstInt, (int)secondInt);
	MOV	[W14+2], W12
	MOV	[W14+0], W11
	MOV	#lo_addr(_ind_dcu_board), W10
	CALL	_dd_Indicator_setIntCoupleValueP
;DPX.c,218 :: 		if(thirdInt == COMMAND_DCU_IS_ACQUIRING){
	MOV	[W14+4], W0
	CP	W0, #1
	BRA Z	L__CAN_Interrupt56
	GOTO	L_CAN_Interrupt34
L__CAN_Interrupt56:
;DPX.c,219 :: 		dDCU_isAcquiringSet();
	CALL	_dDCU_isAcquiringSet
;DPX.c,220 :: 		dDCU_sentAcquiringSignal();
