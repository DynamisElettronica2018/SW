...
;DPX.c,37 :: 		void main(){
;DPX.c,39 :: 		setAllPinAsDigital();
	PUSH	W10
	PUSH	W11
	PUSH	W12
	CALL	_setAllPinAsDigital
;DPX.c,40 :: 		Debug_UART_Init();
	CALL	_Debug_UART_Init
;DPX.c,42 :: 		if (!dHardReset_hasBeenReset())
	CALL	_dHardReset_hasBeenReset
	CP0.B	W0
	BRA Z	L__main38
	GOTO	L_main0
L__main38:
;DPX.c,44 :: 		delay_ms(250);
	MOV	#26, W8
	MOV	#28274, W7
L_main1:
	DEC	W7
...
;DPX.c,45 :: 		}
L_main0:
;DPX.c,47 :: 		d_UIController_init();
	CALL	_d_UIController_init
;DPX.c,49 :: 		if(dHardReset_hasBeenReset()){
	CALL	_dHardReset_hasBeenReset
	CP0.B	W0
	BRA NZ	L__main39
	GOTO	L_main3
L__main39:
;DPX.c,50 :: 		dd_GraphicController_fireTimedNotification(HARD_RESET_NOTIFICATION_TIME, "RESET", WARNING);
	MOV.B	#1, W12
	MOV	#lo_addr(?lstr1_DPX), W11
	MOV	#1000, W10
	CALL	_dd_GraphicController_fireTimedNotification
;DPX.c,51 :: 		dHardReset_unsetFlag();
...
;DPX.c,61 :: 		onTimer2Interrupt{
;DPX.c,62 :: 		clearTimer2();
	PUSH	W10
	BCLR	IFS0bits, #6
;DPX.c,64 :: 		dEfiSense_tick();
	CALL	_dEfiSense_tick
;DPX.c,65 :: 		timer2_counter0 += 1;
	MOV	#1, W1
	MOV	#lo_addr(_timer2_counter0), W0
	ADD	W1, [W0], [W0]
;DPX.c,66 :: 		timer2_counter1 += 1;
	MOV	#1, W1
	MOV	#lo_addr(_timer2_counter1), W0
	ADD	W1, [W0], [W0]
;DPX.c,67 :: 		timer2_counter2 += 1;
	MOV	#1, W1
	MOV	#lo_addr(_timer2_counter2), W0
	ADD	W1, [W0], [W0]
;DPX.c,68 :: 		timer2_counter3 += 1;
	MOV	#1, W1
	MOV	#lo_addr(_timer2_counter3), W0
	ADD	W1, [W0], [W0]
;DPX.c,70 :: 		timer2_counter5 += 1;
	MOV	#1, W1
...
;DPX.c,167 :: 		dd_Indicator_setFloatValueP(&ind_oil_temp_out.base, dEfiSense_calculateOilOutTemperature(secondInt));
	...
	CALL	_dd_Indicator_setFloatValueP
;DPX.c,168 :: 		dd_Indicator_setFloatValueP(&ind_th2o.base, dEfiSense_calculateTemperature(thirdInt));
	MOV	[W14+4], W10
	...
	CALL	_dd_Indicator_setFloatValueP
;DPX.c,169 :: 		dd_Indicator_setFloatValueP(&ind_vbat.base, dEfiSense_calculateVoltage(fourthInt));
	MOV	[W14+6], W10
...
;DPX.c,171 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,172 :: 		case EFI_TRACTION_CONTROL_ID:
L_CAN_Interrupt23:
;DPX.c,173 :: 		dd_Indicator_setFloatValueP(&ind_efi_slip.base, dEfiSense_calculateSlip(thirdInt));
	MOV	[W14+4], W10
...
;DPX.c,174 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,175 :: 		case EFI_FUEL_FAN_H2O_LAUNCH_ID:
L_CAN_Interrupt24:
;DPX.c,176 :: 		dd_Indicator_setIntValueP(&ind_launch_control.base, fourthInt);
	MOV	[W14+6], W11
	MOV	#lo_addr(_ind_launch_control), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,177 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,178 :: 		case EFI_PRESSURES_LAMBDA_SMOT_ID:
L_CAN_Interrupt25:
;DPX.c,179 :: 		dd_Indicator_setFloatValueP(&ind_fuel_press.base, dEfiSense_calculatePressure(firstInt));
	MOV	[W14+0], W10
	...
	CALL	_dd_Indicator_setFloatValueP
;DPX.c,180 :: 		dd_Indicator_setFloatValueP(&ind_oil_press.base, dEfiSense_calculatePressure(secondInt));
	MOV	[W14+2], W10
	CALL	_dEfiSense_calculatePressure
	MOV	W0, W11
	MOV	W1, W12
...
;DPX.c,181 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,182 :: 		case GCU_CLUTCH_FB_SW_ID:
L_CAN_Interrupt26:
;DPX.c,183 :: 		dClutch_injectActualValue(firstInt, (unsigned char)secondInt);
	MOV.B	[W14+2], W11
	MOV	[W14+0], W10
	CALL	_dClutch_injectActualValue
;DPX.c,184 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,191 :: 		case DAU_FR_DEBUG_ID:
L_CAN_Interrupt27:
;DPX.c,192 :: 		dd_Indicator_setIntCoupleValueP(&ind_dau_fr_board.base, (int)firstInt, (int)secondInt);
	MOV	[W14+2], W12
	MOV	[W14+0], W11
...
;DPX.c,193 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,194 :: 		case DAU_FL_DEBUG_ID:
L_CAN_Interrupt28:
;DPX.c,195 :: 		dd_Indicator_setIntCoupleValueP(&ind_dau_fl_board.base, (int)firstInt, (int)secondInt);
	MOV	[W14+2], W12
	MOV	[W14+0], W11
...
;DPX.c,196 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,197 :: 		case DAU_REAR_DEBUG_ID:
L_CAN_Interrupt29:
;DPX.c,198 :: 		dd_Indicator_setIntCoupleValueP(&ind_dau_r_board.base, (int)firstInt, (int)secondInt);
	MOV	[W14+2], W12
	MOV	[W14+0], W11
...
;DPX.c,199 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,204 :: 		case GCU_DEBUG_1_ID:
L_CAN_Interrupt30:
;DPX.c,205 :: 		dd_Indicator_setIntValueP(&ind_gcu_temp.base, (firstInt));
	MOV	[W14+0], W11
	MOV	#lo_addr(_ind_gcu_temp), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,206 :: 		dd_Indicator_setIntValueP(&ind_H2O_fans.base, (secondInt));
	MOV	[W14+2], W11
...
;DPX.c,207 :: 		dd_Indicator_setIntValueP(&ind_H2O_pump.base, (thirdInt));
	...
	CALL	_dd_Indicator_setIntValueP
;DPX.c,208 :: 		dd_Indicator_setIntValueP(&ind_fuel_pump.base, (fourthInt));
	MOV	[W14+6], W11
	MOV	#lo_addr(_ind_fuel_pump), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,209 :: 		break; //*/
	GOTO	L_CAN_Interrupt19
;DPX.c,210 :: 		case GCU_DEBUG_2_ID:
L_CAN_Interrupt31:
;DPX.c,211 :: 		dd_Indicator_setIntValueP(&ind_gear_motor.base, (firstInt));
	MOV	[W14+0], W11
	MOV	#lo_addr(_ind_gear_motor), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,212 :: 		dd_Indicator_setIntValueP(&ind_clutch.base, (secondInt));
	MOV	[W14+2], W11
	MOV	#lo_addr(_ind_clutch), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,213 :: 		dd_Indicator_setIntValueP(&ind_drs.base, (thirdInt));
	MOV	[W14+4], W11
	MOV	#lo_addr(_ind_drs), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,214 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,215 :: 		case DCU_DEBUG_ID:
L_CAN_Interrupt32:
;DPX.c,216 :: 		dd_Indicator_setIntCoupleValueP(&ind_dcu_board.base,(int)firstInt, (int)secondInt);
	MOV	[W14+2], W12
	MOV	[W14+0], W11
	MOV	#lo_addr(_ind_dcu_board), W10
	CALL	_dd_Indicator_setIntCoupleValueP
;DPX.c,217 :: 		if(thirdInt == COMMAND_DCU_IS_ACQUIRING){
	MOV	[W14+4], W0
	CP	W0, #1
	BRA Z	L__CAN_Interrupt55
	GOTO	L_CAN_Interrupt33
L__CAN_Interrupt55:
;DPX.c,218 :: 		dDCU_isAcquiringSet();
	CALL	_dDCU_isAcquiringSet
;DPX.c,219 :: 		dDCU_sentAcquiringSignal();
	CALL	_dDCU_sentAcquiringSignal
;DPX.c,220 :: 		}
L_CAN_Interrupt33:
;DPX.c,221 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,222 :: 		case GCU_AUX_ID:
L_CAN_Interrupt34:
;DPX.c,226 :: 		dAutocross_feedbackGCU(fourthInt);
	MOV	[W14+6], W10
