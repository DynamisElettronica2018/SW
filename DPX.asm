...
L_CAN_Interrupt20:
;DPX.c,144 :: 		dGear_propagate(firstInt);
	MOV	[W14+0], W10
	CALL	_dGear_propagate
;DPX.c,145 :: 		dRpm_set(secondInt);
	MOV	[W14+2], W10
	CALL	_dRpm_set
;DPX.c,146 :: 		dEfiSense_heartbeat();
	CALL	_dEfiSense_heartbeat
;DPX.c,147 :: 		dd_Indicator_setintValueP(&ind_tps.base, dEfiSense_calculateTPS(thirdInt));
	MOV	[W14+4], W10
...
;DPX.c,155 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,156 :: 		case EFI_OIL_T_ENGINE_BAT_ID:
L_CAN_Interrupt22:
...
L_CAN_Interrupt24:
;DPX.c,167 :: 		dd_Indicator_setIntValueP(&ind_launch_control.base, fourthInt);
	MOV	[W14+6], W11
...
L_CAN_Interrupt27:
;DPX.c,183 :: 		dd_Indicator_setIntCoupleValueP(&ind_dau_fr_board.base, (int)firstInt, (int)secondInt);
	MOV	[W14+2], W12
	MOV	[W14+0], W11
