...
;DPX.c,151 :: 		dEfiSense_getAccValue(dEfiSense_calculateTPS(thirdInt));
	MOV	[W14+4], W10
...
;DPX.c,157 :: 		dd_Indicator_setFloatValueP(&ind_th2o_dx_out.base, dEfiSense_calculateWaterTemperature(fourthInt));
	...
	CALL	_dd_Indicator_setFloatValueP
;DPX.c,158 :: 		dEfiSense_heartbeat();
	CALL	_dEfiSense_heartbeat
;DPX.c,159 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,160 :: 		case EFI_OIL_T_ENGINE_BAT_ID:
L_CAN_Interrupt22:
...
L_CAN_Interrupt23:
;DPX.c,168 :: 		if(dEfiSense_calculateSpeed(firstInt)>=EFI_SENSE_MIN_SPEED)
	MOV	[W14+0], W10
...
L__CAN_Interrupt57:
;DPX.c,169 :: 		dControls_disableCentralSelector();
	CALL	_dControls_disableCentralSelector
L_CAN_Interrupt24:
;DPX.c,170 :: 		dd_Indicator_setFloatValueP(&ind_efi_slip.base, dEfiSense_calculateSlip(thirdInt));
	MOV	[W14+4], W10
...
;DPX.c,171 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,172 :: 		case EFI_FUEL_FAN_H2O_LAUNCH_ID:
L_CAN_Interrupt25:
;DPX.c,173 :: 		dd_Indicator_setIntValueP(&ind_launch_control.base, fourthInt);
	MOV	[W14+6], W11
	MOV	#lo_addr(_ind_launch_control), W10
	CALL	_dd_Indicator_setIntValueP
;DPX.c,174 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,175 :: 		case EFI_PRESSURES_LAMBDA_SMOT_ID:
L_CAN_Interrupt26:
;DPX.c,176 :: 		dd_Indicator_setFloatValueP(&ind_fuel_press.base, dEfiSense_calculatePressure(firstInt));
	MOV	[W14+0], W10
	...
	CALL	_dd_Indicator_setFloatValueP
;DPX.c,177 :: 		dd_Indicator_setFloatValueP(&ind_oil_press.base, dEfiSense_calculatePressure(secondInt));
	MOV	[W14+2], W10
	CALL	_dEfiSense_calculatePressure
	MOV	W0, W11
	MOV	W1, W12
...
;DPX.c,178 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,179 :: 		case GCU_CLUTCH_FB_SW_ID:
L_CAN_Interrupt27:
;DPX.c,180 :: 		dClutch_injectActualValue((unsigned char)firstInt);
	MOV.B	[W14+0], W10
...
L_CAN_Interrupt29:
;DPX.c,189 :: 		dd_Indicator_setIntCoupleValueP(&ind_dau_fr_board.base, (int)firstInt, (int)secondInt);
	MOV	[W14+2], W12
	MOV	[W14+0], W11
...
;DPX.c,213 :: 		dd_Indicator_setIntCoupleValueP(&ind_dcu_board.base,(int)firstInt, (int)secondInt);
	...
	CALL	_dd_Indicator_setIntCoupleValueP
;DPX.c,214 :: 		if(thirdInt == COMMAND_DCU_IS_ACQUIRING){
	MOV	[W14+4], W0
	CP	W0, #1
	BRA Z	L__CAN_Interrupt58
	GOTO	L_CAN_Interrupt35
L__CAN_Interrupt58:
;DPX.c,215 :: 		dDCU_isAcquiringSet();
	CALL	_dDCU_isAcquiringSet
;DPX.c,216 :: 		dDCU_sentAcquiringSignal();
	CALL	_dDCU_sentAcquiringSignal
;DPX.c,217 :: 		}
L_CAN_Interrupt35:
;DPX.c,218 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,219 :: 		case GCU_AUX_ID:
L_CAN_Interrupt36:
;DPX.c,220 :: 		d_traction_control_setValueFromCAN(firstInt);
	MOV	[W14+0], W10
	CALL	_d_traction_control_setValueFromCAN
;DPX.c,221 :: 		dAcc_feedbackGCU(secondInt);
	MOV	[W14+2], W10
	CALL	_dAcc_feedbackGCU
;DPX.c,223 :: 		dAutocross_feedbackGCU(fourthInt);
	MOV	[W14+6], W10
	CALL	_dAutocross_feedbackGCU
;DPX.c,224 :: 		Buzzer_bip();
	CALL	_Buzzer_bip
;DPX.c,225 :: 		break;
	GOTO	L_CAN_Interrupt19
;DPX.c,226 :: 		default:
