...
void Can_init() {
    ...
    CAN1SetMask(_CAN_MASK_B2, SW_MASK_EFI_DEBUG_IMU_EBB, _CAN_CONFIG_MATCH_MSG_TYPE & _CAN_CONFIG_STD_MSG);
    CAN1SetFilter(_CAN_FILTER_B2_F1, SW_FILTER_EFI_DEBUG, _CAN_CONFIG_STD_MSG);
    CAN1SetFilter(_CAN_FILTER_B2_F2, SW_FILTER_IMU_EBB, _CAN_CONFIG_STD_MSG);
