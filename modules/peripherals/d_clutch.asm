...
;d_clutch.c,25 :: 		void dClutch_injectActualValue(unsigned char value) {
;d_clutch.c,26 :: 		dClutch_actualValue = value;
	PUSH	W10
	PUSH	W11
	MOV	#lo_addr(_dClutch_actualValue), W0
	MOV.B	W10, [W0]
;d_clutch.c,27 :: 		dd_Indicator_setIntValueP(&ind_clutch_pos.base, dClutch_actualValue);
	ZE	W10, W11
