...
;d_clutch.c,20 :: 		void dClutch_set(unsigned char value) {
;d_clutch.c,21 :: 		if (value > 100) {
	MOV.B	#100, W0
	CP.B	W10, W0
	BRA GTU	L__dClutch_set4
	GOTO	L_dClutch_set0
L__dClutch_set4:
;d_clutch.c,22 :: 		value = 100;
	MOV.B	#100, W10
;d_clutch.c,23 :: 		}
L_dClutch_set0:
;d_clutch.c,24 :: 		dClutch_value = value;
	MOV	#lo_addr(_dClutch_value), W0
	MOV.B	W10, [W0]
;d_clutch.c,25 :: 		}
L_end_dClutch_set:
...
;d_clutch.c,31 :: 		dSignalLed_switch(DSIGNAL_LED_GREEN);
	CLR	W10
