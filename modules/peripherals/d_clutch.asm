...
;d_clutch.c,21 :: 		dClutch_value = value;
	MOV	#lo_addr(_dClutch_value), W0
	MOV.B	W10, [W0]
;d_clutch.c,22 :: 		dd_Indicator_setIntValueP(&ind_clutch_fb.base, dClutch_value);
	ZE	W10, W11
...
;d_clutch.c,25 :: 		void dClutch_injectActualValue(unsigned int clutch_check, unsigned char value) {
;d_clutch.c,26 :: 		if (clutch_check == GCU_COMMAND_IS_ALIVE){
	PUSH	W10
	MOV	#99, W0
	CP	W10, W0
...
;d_clutch.c,27 :: 		dClutch_actualValue = value;
	MOV	#lo_addr(_dClutch_actualValue), W0
	MOV.B	W11, [W0]
;d_clutch.c,28 :: 		dd_Indicator_setIntValueP(&ind_clutch_pos.base, dClutch_actualValue);
	ZE	W11, W11
...
;d_clutch.c,32 :: 		unsigned char dClutch_get(void) {
;d_clutch.c,33 :: 		return dClutch_actualValue;
	MOV	#lo_addr(_dClutch_actualValue), W0
	MOV.B	[W0], W0
;d_clutch.c,34 :: 		}
L_end_dClutch_get:
