...
;d_ebb.c,26 :: 		void dEbb_printNotification(void){
;d_ebb.c,27 :: 		switch (dEbb_value){
	PUSH	W10
	PUSH	W11
	PUSH	W12
...
;d_ebb.c,29 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB -7", MESSAGE);
	CLR	W12
...
;d_ebb.c,32 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB -6", MESSAGE);
	CLR	W12
...
;d_ebb.c,35 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB -5", MESSAGE);
	CLR	W12
...
;d_ebb.c,38 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB -4", MESSAGE);
	CLR	W12
...
;d_ebb.c,41 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB -3", MESSAGE);
	CLR	W12
...
;d_ebb.c,44 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB -2", MESSAGE);
	CLR	W12
...
;d_ebb.c,47 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB -1", MESSAGE);
	CLR	W12
...
;d_ebb.c,50 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB 0", MESSAGE);
	CLR	W12
...
;d_ebb.c,53 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB 1", MESSAGE);
	CLR	W12
...
;d_ebb.c,56 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB 2", MESSAGE);
	CLR	W12
...
;d_ebb.c,59 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB 3", MESSAGE);
	CLR	W12
...
;d_ebb.c,62 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB 4", MESSAGE);
	CLR	W12
...
;d_ebb.c,65 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB 5", MESSAGE);
	CLR	W12
...
;d_ebb.c,68 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB 6", MESSAGE);
	CLR	W12
...
;d_ebb.c,71 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB 7", MESSAGE);
	CLR	W12
...
;d_ebb.c,78 :: 		void dEbb_setEbbValueFromCAN(unsigned int value){
;d_ebb.c,79 :: 		dEbb_Value = (int)(value - EBB_DAGO_OFFSET);
	PUSH	W10
	PUSH	W11
	SUB	W10, #8, W1
	MOV	#lo_addr(_dEbb_value), W0
	MOV.B	W1, [W0]
;d_ebb.c,80 :: 		dd_Indicator_setIntValueP(&ind_ebb.base, (int) (dEbb_value));
	SE	W1, W0
	MOV	W0, W11
...
;d_ebb.c,85 :: 		void dEbb_propagateEbbChange(void) {
;d_ebb.c,86 :: 		switch (dEbb_state){
	PUSH	W10
	PUSH	W11
	GOTO	L_dEbb_propagateEbbChange18
;d_ebb.c,99 :: 		default:
L_dEbb_propagateEbbChange20:
;d_ebb.c,100 :: 		dd_Indicator_setIntValueP(&ind_ebb.base, (int) (dEbb_value));
	MOV	#lo_addr(_dEbb_value), W0
	SE	[W0], W0
	MOV	W0, W11
	MOV	#lo_addr(_ind_ebb), W10
...
;d_ebb.c,105 :: 		void dEbb_propagateValue(signed char value){
;d_ebb.c,106 :: 		Can_writeInt(SW_BRAKE_BIAS_EBB_ID, (int)(value + EBB_DAGO_OFFSET));
	PUSH	W10
	PUSH	W11
	PUSH	W12
	SE	W10, W0
	...
	CALL	_Can_writeInt
	POP	W10
;d_ebb.c,107 :: 		dd_Indicator_setIntValueP(&ind_ebb.base, (int) (value));
	SE	W10, W0
	MOV	W0, W11
	MOV	#lo_addr(_ind_ebb), W10
	CALL	_dd_Indicator_setIntValueP
...
;d_ebb.c,111 :: 		void dEbb_move(signed char movements){
;d_ebb.c,113 :: 		if(!dEbb_errorOccurred){
	PUSH	W10
	PUSH	W11
	PUSH	W12
	...
	GOTO	L_dEbb_move21
L__dEbb_move55:
;d_ebb.c,114 :: 		value = dEbb_value - movements;
	MOV	#lo_addr(_dEbb_value), W0
	SE	[W0], W1
	SE	W10, W0
	SUB	W1, W0, W0
; value start address is: 2 (W1)
	MOV.B	W0, W1
;d_ebb.c,115 :: 		if(value > EBB_MAX_VALUE){
	CP.B	W0, #3
	BRA GT	L__dEbb_move56
	GOTO	L_dEbb_move22
L__dEbb_move56:
;d_ebb.c,116 :: 		value = EBB_MAX_VALUE;
	MOV.B	#3, W1
;d_ebb.c,117 :: 		} else if(value < EBB_MIN_VALUE){
	GOTO	L_dEbb_move23
L_dEbb_move22:
	MOV.B	#253, W0
	CP.B	W1, W0
...
;d_ebb.c,118 :: 		value = EBB_MIN_VALUE;
...
; value end address is: 2 (W1)
L_dEbb_move23:
;d_ebb.c,120 :: 		dEbb_Value = value;
; value start address is: 2 (W1)
	MOV	#lo_addr(_dEbb_value), W0
	MOV.B	W1, [W0]
;d_ebb.c,121 :: 		dEbb_propagateValue(value);
	MOV.B	W1, W10
; value end address is: 2 (W1)
...
;d_ebb.c,122 :: 		}else
	GOTO	L_dEbb_move25
L_dEbb_move21:
;d_ebb.c,123 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB ERROR", MESSAGE);
	CLR	W12
