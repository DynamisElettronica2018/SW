...
;d_ebb.c,102 :: 		dd_Indicator_setIntValueP(&ind_ebb.base, (int) (dEbb_value));
	...
	MOV	#lo_addr(_ind_ebb), W10
	CALL	_dd_Indicator_setIntValueP
;d_ebb.c,103 :: 		dEbb_printNotification();
	CALL	_dEbb_printNotification
;d_ebb.c,104 :: 		break;
...
;d_ebb.c,109 :: 		Can_writeInt(SW_BRAKE_BIAS_EBB_ID, (int)(value + EBB_DAGO_OFFSET));
	...
	CALL	_Can_writeInt
	POP	W10
;d_ebb.c,110 :: 		dd_Indicator_setIntValueP(&ind_ebb.base, (int) (value)); +
	SE	W10, W0
	MOV	W0, W11
	MOV	#lo_addr(_ind_ebb), W10
	CALL	_dd_Indicator_setIntValueP
;d_ebb.c,111 :: 		dEbb_printNotification();
	CALL	_dEbb_printNotification
;d_ebb.c,112 :: 		}
...
;d_ebb.c,114 :: 		void dEbb_move(signed char movements){
;d_ebb.c,116 :: 		if(!dEbb_errorOccurred){
	PUSH	W10
	PUSH	W11
	PUSH	W12
...
;d_ebb.c,125 :: 		}else
	GOTO	L_dEbb_move25
L_dEbb_move21:
;d_ebb.c,126 :: 		dd_GraphicController_fireTimedNotification(EBB_NOTIFICATION_TIME, "EBB ERROR", MESSAGE);
	CLR	W12
	MOV	#lo_addr(?lstr16_d_ebb), W11
	MOV	#1000, W10
	CALL	_dd_GraphicController_fireTimedNotification
L_dEbb_move25:
;d_ebb.c,127 :: 		dd_Indicator_setStringValueP(EBB, "/");
...
;d_ebb.c,130 :: 		void dEbb_init(void){
;d_ebb.c,132 :: 		}
L_end_dEbb_init:
	RETURN
; end of _dEbb_init
...
;d_ebb.c,134 :: 		void dEbb_setPositionZero(void){
;d_ebb.c,135 :: 		if(!dEbb_errorOccurred){
	PUSH	W10
	PUSH	W11
	PUSH	W12
	MOV	#lo_addr(_dEbb_errorOccurred), W0
...
;d_ebb.c,136 :: 		Can_writeInt(SW_BRAKE_BIAS_EBB_ID, EBB_SET_ZERO);
	MOV	#100, W12
	MOV	#1024, W10
	MOV	#0, W11
	CALL	_Can_writeInt
;d_ebb.c,137 :: 		dEbb_Value = 0;
	MOV	#lo_addr(_dEbb_value), W1
	CLR	W0
	MOV.B	W0, [W1]
;d_ebb.c,138 :: 		dd_GraphicController_fireTimedNotification(1000, "CALIBRATE", MESSAGE);
	CLR	W12
	MOV	#lo_addr(?lstr18_d_ebb), W11
	MOV	#1000, W10
	CALL	_dd_GraphicController_fireTimedNotification
;d_ebb.c,139 :: 		dEbb_isSetZero = TRUE;
	MOV	#1, W0
...
;d_ebb.c,143 :: 		void dEbb_calibrationState(unsigned int value){
;d_ebb.c,144 :: 		if(dEbb_isSetZero == TRUE && value == TRUE){
...
;d_ebb.c,145 :: 		dEbb_isSetZero = FALSE;
	CLR	W0
	MOV	W0, _dEbb_isSetZero
;d_ebb.c,144 :: 		if(dEbb_isSetZero == TRUE && value == TRUE){
...
;d_ebb.c,149 :: 		void dEbb_error(unsigned int value){
;d_ebb.c,150 :: 		if(value == EBB_ERROR){
	PUSH	W10
	PUSH	W11
	PUSH	W12
	CP	W10, #1
	...
	GOTO	L_dEbb_error30
L__dEbb_error65:
;d_ebb.c,151 :: 		dEbb_errorOccurred = EBB_ERROR;
	MOV	#1, W0
	MOV	W0, _dEbb_errorOccurred
;d_ebb.c,152 :: 		dd_GraphicController_fireTimedNotification(1000, "EBB ERROR", ERROR);
	MOV.B	#2, W12
	MOV	#lo_addr(?lstr19_d_ebb), W11
	MOV	#1000, W10
	CALL	_dd_GraphicController_fireTimedNotification
;d_ebb.c,153 :: 		dd_Indicator_setStringValueP(EBB, "/");
