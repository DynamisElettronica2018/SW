...
;dd_interfaces.c,73 :: 		eGlcd_setFont(INTERFACE_TITLE_FONT);
	...
	POP	W10
;dd_interfaces.c,74 :: 		eGlcd_writeText(title, dd_Interface_getTitleX(title), dd_Interface_getTitleY());  //lo incapsulerei in una funzione writeCenteredText
...
;dd_interfaces.c,93 :: 		void dd_printMessage(char * title)
;dd_interfaces.c,95 :: 		unsigned int width = 0;
	PUSH	W11
	PUSH	W12
	PUSH	W13
;dd_interfaces.c,97 :: 		eGlcd_setFont(INTERFACE_TITLE_FONT);
	PUSH	W10
	MOV	#32, W13
	MOV.B	#16, W12
	MOV.B	#16, W11
	...
	CALL	_xGlcd_Set_Font
	POP	W10
;dd_interfaces.c,98 :: 		width = eGlcd_getTextPixelLength(title);
	PUSH	W10
	CALL	_eGlcd_getTextPixelLength
	POP	W10
;dd_interfaces.c,99 :: 		x_origin = SCREEN_X_MIDDLE-width/2;
	LSR	W0, #1, W2
	MOV.B	#64, W1
; x_origin start address is: 4 (W2)
	SUB.B	W1, W2, W2
;dd_interfaces.c,100 :: 		y_origin = SCREEN_Y_MIDDLE-INTERFACE_TITLE_FONT_HEIGHT/2;
; y_origin start address is: 6 (W3)
	MOV.B	#24, W3
;dd_interfaces.c,101 :: 		eGlcd_drawRect(x_origin-INTERFACE_TITLE_X_MARGIN, y_origin-INTERFACE_TITLE_Y_MARGIN, width+2*INTERFACE_TITLE_X_MARGIN,
	ADD	W0, #24, W1
	ZE	W2, W0
	SUB	W0, #12, W0
;dd_interfaces.c,102 :: 		INTERFACE_TITLE_FONT_HEIGHT+2*INTERFACE_TITLE_Y_MARGIN);
	PUSH.D	W2
	PUSH	W10
	MOV.B	#24, W13
;dd_interfaces.c,101 :: 		eGlcd_drawRect(x_origin-INTERFACE_TITLE_X_MARGIN, y_origin-INTERFACE_TITLE_Y_MARGIN, width+2*INTERFACE_TITLE_X_MARGIN,
...
;dd_interfaces.c,102 :: 		INTERFACE_TITLE_FONT_HEIGHT+2*INTERFACE_TITLE_Y_MARGIN);
	...
	POP	W10
	POP.D	W2
;dd_interfaces.c,104 :: 		eGlcd_writeText(title, x_origin, y_origin);
	MOV.B	W3, W12
...
;dd_interfaces.c,107 :: 		void dd_Interface_printBoardDebug(){
;dd_interfaces.c,108 :: 		dd_boardDebug_print();
...
;dd_interfaces.c,111 :: 		void dd_Interface_printMenu() {
;dd_interfaces.c,112 :: 		dd_printMenu();
	CALL	_dd_printMenu
;dd_interfaces.c,113 :: 		}
