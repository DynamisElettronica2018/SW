...
;dd_graphic_controller.c,87 :: 		DD_BACKLIGHT_PIN_DIRECTION = OUTPUT;
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
	BCLR	TRISG13_bit, BitPos(TRISG13_bit+0)
;dd_graphic_controller.c,88 :: 		dd_GraphicController_turnOnBacklight();
	CALL	_dd_GraphicController_turnOnBacklight
;dd_graphic_controller.c,89 :: 		eGlcd_init();
	CALL	_eGlcd_init
;dd_graphic_controller.c,90 :: 		eGlcd_clear();
	CALL	_eGlcd_clear
;dd_graphic_controller.c,91 :: 		eGlcd_setFont(DD_Dashboard_Font);
	MOV	#32, W13
	MOV.B	#16, W12
	MOV.B	#16, W11
	MOV	#lo_addr(dd_graphic_controller_DynamisFont_Dashboard16x16), W10
	CALL	_xGlcd_Set_Font
;dd_graphic_controller.c,92 :: 		if (!dHardReset_hasBeenReset()) {
...
;dd_graphic_controller.c,93 :: 		dd_GraphicController_startupLogo();
	CALL	_dd_GraphicController_startupLogo
;dd_graphic_controller.c,94 :: 		}
L_dd_GraphicController_init0:
;dd_graphic_controller.c,95 :: 		dd_GraphicController_timerSetup();
	CALL	_dd_GraphicController_timerSetup
;dd_graphic_controller.c,96 :: 		dd_GraphicController_forceFullFrameUpdate();
...
;dd_graphic_controller.c,99 :: 		void dd_GraphicController_invertColors(void) {
;dd_graphic_controller.c,100 :: 		dd_GraphicController_queueColorInversion();
	CALL	_dd_GraphicController_queueColorInversion
;dd_graphic_controller.c,101 :: 		eGlcd_invertColors();
	CALL	_eGlcd_invertColors
;dd_graphic_controller.c,102 :: 		dd_GraphicController_forceNextFrameUpdate();
...
;dd_graphic_controller.c,105 :: 		char dd_GraphicController_areColorsInverted(void) {
;dd_graphic_controller.c,106 :: 		return BLACK == PIXEL_OFF;
	MOV.B	#_BLACK, W0
	CP.B	W0, #0
	CLR.B	W0
...
;dd_graphic_controller.c,109 :: 		void dd_GraphicController_setInterface(Interface interface) {
;dd_graphic_controller.c,110 :: 		dd_isInterfaceChangedFromLastFrame = TRUE;
	MOV	#lo_addr(dd_graphic_controller_dd_isInterfaceChangedFromLastFrame), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,111 :: 		dd_onInterfaceChange = TRUE;
	MOV	#lo_addr(_dd_onInterfaceChange), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,112 :: 		dd_isFrameUpdateForced = TRUE;
	MOV	#lo_addr(dd_graphic_controller_dd_isFrameUpdateForced), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,113 :: 		dd_onInterfaceChangeCounterLimit = dd_GraphicController_getTmrCounterLimit(OP_MODE_POPUP_PERIOD);
	PUSH	W10
	MOV	#700, W10
	CALL	_dd_GraphicController_getTmrCounterLimit
	POP	W10
...
;dd_graphic_controller.c,119 :: 		dd_Interface_init[dd_currentInterface]();
	MOV	#lo_addr(dd_graphic_controller_dd_currentInterface), W0
	ZE	[W0], W0
	SL	W0, #1, W1
	...
	POP	W11
	POP.D	W12
;dd_graphic_controller.c,120 :: 		if ( strlen(title) < MAX_INTERFACE_TITLE_LENGTH )
	MOV	W13, W10
	CALL	_strlen
	CP	W0, #20
...
;dd_graphic_controller.c,121 :: 		strcpy(dd_currentInterfaceTitle, title);
	PUSH	W11
	MOV	W13, W11
...
;dd_graphic_controller.c,122 :: 		dd_currentIndicators = indicator_collection;
	MOV	W11, _dd_currentIndicators
;dd_graphic_controller.c,123 :: 		dd_currentIndicatorsCount = indicator_count;
...
;dd_graphic_controller.c,126 :: 		Interface dd_GraphicController_getInterface(void) {
;dd_graphic_controller.c,127 :: 		return dd_currentInterface;
	MOV	#lo_addr(dd_graphic_controller_dd_currentInterface), W0
	MOV.B	[W0], W0
...
;dd_graphic_controller.c,130 :: 		void dd_GraphicController_saveCurrentInterface(void) {
;dd_graphic_controller.c,131 :: 		strcpy(dd_lastInterfaceTitle, dd_currentInterfaceTitle);
	PUSH	W10
	PUSH	W11
	MOV	#lo_addr(_dd_currentInterfaceTitle), W11
	MOV	#lo_addr(dd_graphic_controller_dd_lastInterfaceTitle), W10
	CALL	_strcpy
;dd_graphic_controller.c,132 :: 		dd_lastInterface = dd_currentInterface;
...
;dd_graphic_controller.c,135 :: 		void dd_GraphicController_setNotificationFlag (void){
...
;dd_graphic_controller.c,143 :: 		void dd_GraphicController_clearNotification(void) {
;dd_graphic_controller.c,144 :: 		eGlcd_clear();
	CALL	_eGlcd_clear
;dd_graphic_controller.c,145 :: 		dd_isFrameUpdateForced = TRUE;
	MOV	#lo_addr(dd_graphic_controller_dd_isFrameUpdateForced), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,146 :: 		dd_GraphicController_unsetNotificationFlag();
...
;dd_graphic_controller.c,149 :: 		void dd_GraphicController_fireNotification(char *text, NotificationType type) {
;dd_graphic_controller.c,150 :: 		strcpy(dd_notificationText, text);
	PUSH	W10
	PUSH	W11
	MOV	W10, W11
	MOV	#lo_addr(_dd_notificationText), W10
	CALL	_strcpy
;dd_graphic_controller.c,151 :: 		dd_printMessage(dd_notificationText);
	MOV	#lo_addr(_dd_notificationText), W10
...
;dd_graphic_controller.c,157 :: 		void dd_GraphicController_fireTimedNotification(unsigned int time, char *text, NotificationType type) {
;dd_graphic_controller.c,158 :: 		dd_notificationTimeoutCounter = dd_GraphicController_getTmrCounterLimit(time);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W11
...
;dd_graphic_controller.c,159 :: 		dd_GraphicController_setNotificationFlag();
	CALL	_dd_GraphicController_setNotificationFlag
;dd_graphic_controller.c,160 :: 		dd_notificationIsTimed = 1;
	MOV	#lo_addr(_dd_notificationIsTimed), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,161 :: 		dd_GraphicController_fireNotification(text, type);
	MOV	W11, W10
	MOV.B	W12, W11
...
;dd_graphic_controller.c,164 :: 		void dd_GraphicController_firePromptNotification(char *text) {
;dd_graphic_controller.c,165 :: 		if(dd_notificationFlag)
	PUSH	W11
...
;dd_graphic_controller.c,166 :: 		dd_GraphicController_clearNotification();
	PUSH	W10
...
;dd_graphic_controller.c,168 :: 		eGlcd_clear();
	PUSH	W10
	CALL	_eGlcd_clear
	POP	W10
L_dd_GraphicController_firePromptNotification3:
;dd_graphic_controller.c,170 :: 		dd_notificationIsTimed = 0;
	MOV	#lo_addr(_dd_notificationIsTimed), W1
	CLR	W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,171 :: 		dd_GraphicController_fireNotification(text, PROMPT);
	MOV.B	#3, W11
	CALL	_dd_GraphicController_fireNotification
...
;dd_graphic_controller.c,174 :: 		void dd_GraphicController_clearPrompt()
;dd_graphic_controller.c,176 :: 		dd_Interface_print[dd_currentInterface]();
	MOV	#lo_addr(dd_graphic_controller_dd_currentInterface), W0
	ZE	[W0], W0
	SL	W0, #1, W1
...
;dd_graphic_controller.c,210 :: 		void dd_GraphicController_forceFullFrameUpdate(void) {
;dd_graphic_controller.c,211 :: 		dd_isFrameUpdateForced = TRUE;
	MOV	#lo_addr(dd_graphic_controller_dd_isFrameUpdateForced), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
...
;dd_graphic_controller.c,214 :: 		void dd_GraphicController_releaseFullFrameUpdate(void) {
;dd_graphic_controller.c,215 :: 		dd_isFrameUpdateForced = FALSE;
	MOV	#lo_addr(dd_graphic_controller_dd_isFrameUpdateForced), W1
	CLR	W0
	MOV.B	W0, [W1]
...
;dd_graphic_controller.c,218 :: 		void dd_GraphicController_forceNextFrameUpdate(void) {
;dd_graphic_controller.c,219 :: 		dd_isNextFrameUpdateForced = TRUE;
...
;dd_graphic_controller.c,222 :: 		char dd_GraphicController_isFrameUpdateForced(void) {
;dd_graphic_controller.c,223 :: 		return dd_isFrameUpdateForced;
...
;dd_graphic_controller.c,226 :: 		void dd_GraphicController_queueColorInversion(void) {
;dd_graphic_controller.c,227 :: 		dd_isColorInversionQueued = TRUE;
...
;dd_graphic_controller.c,230 :: 		char dd_GraphicController_isColorInversionQueued(void) {               //inutile
;dd_graphic_controller.c,231 :: 		return dd_isColorInversionQueued;
...
;dd_graphic_controller.c,234 :: 		void dd_printLogoAnimation() {
;dd_graphic_controller.c,235 :: 		char page = 0;
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
;dd_graphic_controller.c,236 :: 		int i =0, j=0, k=0;
;dd_graphic_controller.c,237 :: 		signed char new_y = 0;
;dd_graphic_controller.c,238 :: 		signed char old_y = 0;
;dd_graphic_controller.c,239 :: 		int y_center = 19;
	MOV	#19, W0
	MOV	W0, [W14+8]
;dd_graphic_controller.c,241 :: 		signed char new_y_border = 0;
;dd_graphic_controller.c,243 :: 		eGlcd_LoadImage(DYNAMIS_LOGO);
	MOV	#lo_addr(dd_graphic_controller_DYNAMIS_LOGO), W10
	CALL	_eGlcd_loadImage
;dd_graphic_controller.c,247 :: 		for (k=5; k<=120; k++){
	MOV	#5, W0
	MOV	W0, [W14+4]
...
;dd_graphic_controller.c,248 :: 		resetTimer32();
	CALL	_resetTimer32
;dd_graphic_controller.c,249 :: 		cos_angle = cos(0.10466*k);
	MOV	[W14+4], W0
	ASR	W0, #15, W1
	SETM	W2
	CALL	__Long2Float
	...
	MOV	W0, [W14+0]
	MOV	W1, [W14+2]
;dd_graphic_controller.c,250 :: 		new_y_border = round((cos_angle*17));
	MOV	#0, W2
	MOV	#16776, W3
	CALL	__Mul_FP
	MOV.D	W0, W10
	CALL	_round
	MOV.B	W0, [W14+10]
;dd_graphic_controller.c,251 :: 		if (new_y_border<0) new_y_border = -new_y_border;
	CP.B	W0, #0
...
;dd_graphic_controller.c,252 :: 		for (i=0; i<=17-new_y_border; i++)
...
;dd_graphic_controller.c,254 :: 		for (j=0; j<8; j++)
...
;dd_graphic_controller.c,256 :: 		frameBuff[j*64+i] = 0xFF;
	SL	W2, #6, W0
	ADD	W0, W8, W1
	...
	MOV.B	#255, W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,257 :: 		frameBuff[j*64+i+y_center+new_y_border] = 0xFF;
	SL	W2, #6, W0
	ADD	W0, W8, W1
	ADD	W14, #8, W0
	ADD	W1, [W0], W1
...
;dd_graphic_controller.c,260 :: 		for (new_y=-new_y_border; new_y<=new_y_border; new_y++)
	MOV.B	[W14+10], W1
	ADD	W14, #6, W0
	SUBR.B	W1, #0, [W0]
...
;dd_graphic_controller.c,262 :: 		old_y = round(new_y/cos_angle);
	ADD	W14, #6, W2
	SE	[W2], W0
	ASR	W0, #15, W1
	SETM	W2
...
; old_y start address is: 12 (W6)
	MOV.B	W0, W6
;dd_graphic_controller.c,263 :: 		for (page = 0; page<8; page++)
...
; old_y end address is: 12 (W6)
;dd_graphic_controller.c,265 :: 		i = page*2*64+old_y+y_center;
; old_y start address is: 12 (W6)
	ZE	W4, W0
	SL	W0, #1, W0
	SL	W0, #6, W1
	...
	ADD	W14, #8, W0
	ADD	W1, [W0], W3
;dd_graphic_controller.c,266 :: 		j = page*64+new_y+y_center;
	ZE	W4, W0
	SL	W0, #6, W1
	ADD	W14, #6, W0
	SE	[W0], W0
	...
	ADD	W14, #8, W0
	ADD	W1, [W0], W1
;dd_graphic_controller.c,267 :: 		frameBuff[j] = DYNAMIS_LOGO[i];
	MOV	#lo_addr(_frameBuff), W0
	ADD	W1, [W0], W2
...
;dd_graphic_controller.c,270 :: 		Lcd_PrintFrame();
	CALL	_Lcd_PrintFrame
;dd_graphic_controller.c,271 :: 		Delay_Cyc(floor(pow(k*8,2)/30000+new_y_border/10), k*700);
	MOV	[W14+4], W1
	MOV	#700, W0
	MUL.SS	W1, W0, W0
	MOV	W0, [W14+22]
...
;dd_graphic_controller.c,276 :: 		void dd_GraphicController_onTimerInterrupt(void)
...
;dd_graphic_controller.c,326 :: 		Lcd_PrintFrame();
	CALL	_Lcd_PrintFrame
;dd_graphic_controller.c,327 :: 		if (d_UI_getOperatingMode() == ACC_MODE){
...
;dd_graphic_controller.c,328 :: 		dd_printMessage("READY");
...
;dd_graphic_controller.c,337 :: 		}else{
...
;dd_graphic_controller.c,348 :: 		clearTimer1();
	BCLR	IFS0bits, #3
