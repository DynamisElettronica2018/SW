...
;dd_graphic_controller.c,93 :: 		if (!dHardReset_hasBeenReset()) {
	...
	CP0.B	W0
	BRA Z	L__dd_GraphicController_init40
	GOTO	L_dd_GraphicController_init0
L__dd_GraphicController_init40:
...
;dd_graphic_controller.c,107 :: 		return BLACK == PIXEL_OFF;
	...
	CP.B	W0, #0
	CLR.B	W0
	BRA NZ	L__dd_GraphicController_areColorsInverted43
	INC.B	W0
L__dd_GraphicController_areColorsInverted43:
...
;dd_graphic_controller.c,126 :: 		if ( strlen(title) < MAX_INTERFACE_TITLE_LENGTH )
	...
	CALL	_strlen
	CP	W0, #20
	BRA LT	L__dd_GraphicController_setCollectionInterface46
	GOTO	L_dd_GraphicController_setCollectionInterface1
L__dd_GraphicController_setCollectionInterface46:
...
;dd_graphic_controller.c,173 :: 		void dd_GraphicController_firePromptNotification(char *text) {
;dd_graphic_controller.c,174 :: 		if(dd_notificationFlag)
	PUSH	W11
	MOV	#lo_addr(dd_graphic_controller_dd_notificationFlag), W0
	CP0.B	[W0]
	BRA NZ	L__dd_GraphicController_firePromptNotification55
	GOTO	L_dd_GraphicController_firePromptNotification2
L__dd_GraphicController_firePromptNotification55:
;dd_graphic_controller.c,175 :: 		dd_GraphicController_clearNotification();
	PUSH	W10
...
;dd_graphic_controller.c,177 :: 		eGlcd_clear();
	PUSH	W10
	CALL	_eGlcd_clear
	POP	W10
L_dd_GraphicController_firePromptNotification3:
;dd_graphic_controller.c,179 :: 		dd_GraphicController_fireNotification(text, PROMPT);
	MOV.B	#3, W11
	CALL	_dd_GraphicController_fireNotification
...
;dd_graphic_controller.c,182 :: 		void dd_GraphicController_clearPrompt()
...
;dd_graphic_controller.c,187 :: 		void dd_GraphicController_handleNotification(void) {
;dd_graphic_controller.c,188 :: 		if (dd_notificationTimeoutCounter > 0) {
	MOV	_dd_notificationTimeoutCounter, W0
	CP	W0, #0
	BRA GTU	L__dd_GraphicController_handleNotification58
	GOTO	L_dd_GraphicController_handleNotification4
L__dd_GraphicController_handleNotification58:
;dd_graphic_controller.c,189 :: 		dd_notificationTimeoutCounter--;
	MOV	#1, W1
	MOV	#lo_addr(_dd_notificationTimeoutCounter), W0
	SUBR	W1, [W0], [W0]
;dd_graphic_controller.c,190 :: 		if (dd_notificationTimeoutCounter == 0) {
	MOV	_dd_notificationTimeoutCounter, W0
	CP	W0, #0
	BRA Z	L__dd_GraphicController_handleNotification59
	GOTO	L_dd_GraphicController_handleNotification5
L__dd_GraphicController_handleNotification59:
...
;dd_graphic_controller.c,219 :: 		void dd_GraphicController_forceFullFrameUpdate(void) {              //inutile
;dd_graphic_controller.c,220 :: 		dd_isFrameUpdateForced = TRUE;
	MOV	#lo_addr(dd_graphic_controller_dd_isFrameUpdateForced), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
...
;dd_graphic_controller.c,223 :: 		void dd_GraphicController_releaseFullFrameUpdate(void) {
;dd_graphic_controller.c,224 :: 		dd_isFrameUpdateForced = FALSE;
	MOV	#lo_addr(dd_graphic_controller_dd_isFrameUpdateForced), W1
	CLR	W0
	MOV.B	W0, [W1]
...
;dd_graphic_controller.c,227 :: 		void dd_GraphicController_forceNextFrameUpdate(void) {
;dd_graphic_controller.c,228 :: 		dd_isNextFrameUpdateForced = TRUE;
...
;dd_graphic_controller.c,231 :: 		char dd_GraphicController_isFrameUpdateForced(void) {
;dd_graphic_controller.c,232 :: 		return dd_isFrameUpdateForced;
...
;dd_graphic_controller.c,235 :: 		void dd_GraphicController_queueColorInversion(void) {
;dd_graphic_controller.c,236 :: 		dd_isColorInversionQueued = TRUE;
...
;dd_graphic_controller.c,239 :: 		char dd_GraphicController_isColorInversionQueued(void) {               //inutile
;dd_graphic_controller.c,240 :: 		return dd_isColorInversionQueued;
...
;dd_graphic_controller.c,243 :: 		void dd_printLogoAnimation() {
;dd_graphic_controller.c,244 :: 		char page = 0;
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
;dd_graphic_controller.c,245 :: 		int i =0, j=0, k=0;
;dd_graphic_controller.c,246 :: 		signed char new_y = 0;
;dd_graphic_controller.c,247 :: 		signed char old_y = 0;
;dd_graphic_controller.c,248 :: 		int y_center = 19;
	MOV	#19, W0
	MOV	W0, [W14+8]
;dd_graphic_controller.c,250 :: 		signed char new_y_border = 0;
;dd_graphic_controller.c,252 :: 		eGlcd_LoadImage(DYNAMIS_LOGO);
	MOV	#lo_addr(dd_graphic_controller_DYNAMIS_LOGO), W10
	CALL	_eGlcd_loadImage
;dd_graphic_controller.c,256 :: 		for (k=5; k<=120; k++){
	MOV	#5, W0
	MOV	W0, [W14+4]
L_dd_printLogoAnimation6:
	...
	ADD	W14, #4, W0
	CP	W1, [W0]
	BRA GE	L__dd_printLogoAnimation67
	GOTO	L_dd_printLogoAnimation7
L__dd_printLogoAnimation67:
;dd_graphic_controller.c,257 :: 		resetTimer32();
	CALL	_resetTimer32
;dd_graphic_controller.c,258 :: 		cos_angle = cos(0.10466*k);
	MOV	[W14+4], W0
	ASR	W0, #15, W1
	SETM	W2
	CALL	__Long2Float
	...
	MOV	W0, [W14+0]
	MOV	W1, [W14+2]
;dd_graphic_controller.c,259 :: 		new_y_border = round((cos_angle*17));
	MOV	#0, W2
	MOV	#16776, W3
	CALL	__Mul_FP
	MOV.D	W0, W10
	CALL	_round
	MOV.B	W0, [W14+10]
;dd_graphic_controller.c,260 :: 		if (new_y_border<0) new_y_border = -new_y_border;
	CP.B	W0, #0
	BRA LT	L__dd_printLogoAnimation68
...
;dd_graphic_controller.c,261 :: 		for (i=0; i<=17-new_y_border; i++)
...
; i start address is: 16 (W8)
	...
	SUBR	W0, #17, W0
	CP	W8, W0
	BRA LE	L__dd_printLogoAnimation69
	GOTO	L_dd_printLogoAnimation11
L__dd_printLogoAnimation69:
;dd_graphic_controller.c,263 :: 		for (j=0; j<8; j++)
...
;dd_graphic_controller.c,265 :: 		frameBuff[j*64+i] = 0xFF;
	SL	W2, #6, W0
	ADD	W0, W8, W1
	...
	MOV.B	#255, W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,266 :: 		frameBuff[j*64+i+y_center+new_y_border] = 0xFF;
	SL	W2, #6, W0
	ADD	W0, W8, W1
	ADD	W14, #8, W0
	ADD	W1, [W0], W1
...
;dd_graphic_controller.c,269 :: 		for (new_y=-new_y_border; new_y<=new_y_border; new_y++)
	MOV.B	[W14+10], W1
	ADD	W14, #6, W0
	SUBR.B	W1, #0, [W0]
...
;dd_graphic_controller.c,271 :: 		old_y = round(new_y/cos_angle);
	ADD	W14, #6, W2
	SE	[W2], W0
	ASR	W0, #15, W1
	SETM	W2
...
; old_y start address is: 12 (W6)
	MOV.B	W0, W6
;dd_graphic_controller.c,272 :: 		for (page = 0; page<8; page++)
...
; old_y end address is: 12 (W6)
	CP.B	W4, #8
	BRA LTU	L__dd_printLogoAnimation72
	GOTO	L_dd_printLogoAnimation20
L__dd_printLogoAnimation72:
; old_y end address is: 12 (W6)
;dd_graphic_controller.c,274 :: 		i = page*2*64+old_y+y_center;
; old_y start address is: 12 (W6)
	ZE	W4, W0
	SL	W0, #1, W0
	SL	W0, #6, W1
	...
	ADD	W14, #8, W0
	ADD	W1, [W0], W3
;dd_graphic_controller.c,275 :: 		j = page*64+new_y+y_center;
	ZE	W4, W0
	SL	W0, #6, W1
	ADD	W14, #6, W0
	SE	[W0], W0
	...
	ADD	W14, #8, W0
	ADD	W1, [W0], W1
;dd_graphic_controller.c,276 :: 		frameBuff[j] = DYNAMIS_LOGO[i];
	MOV	#lo_addr(_frameBuff), W0
	ADD	W1, [W0], W2
...
;dd_graphic_controller.c,280 :: 		Delay_Cyc(floor(pow(k*8,2)/30000+new_y_border/10), k*700);
	MOV	[W14+4], W1
	MOV	#700, W0
	MUL.SS	W1, W0, W0
	MOV	W0, [W14+22]
...
;dd_graphic_controller.c,285 :: 		void dd_GraphicController_onTimerInterrupt(void)
;dd_graphic_controller.c,290 :: 		if ( __counter == 10 )
	PUSH	W10
	MOV	___counter, W0
	CP	W0, #10
	BRA Z	L__dd_GraphicController_onTimerInterrupt74
	GOTO	L_dd_GraphicController_onTimerInterrupt22
L__dd_GraphicController_onTimerInterrupt74:
;dd_graphic_controller.c,292 :: 		dSignalLed_set(DSIGNAL_LED_RED_RIGHT);
	MOV.B	#1, W10
	CALL	_dSignalLed_set
;dd_graphic_controller.c,293 :: 		}
L_dd_GraphicController_onTimerInterrupt22:
;dd_graphic_controller.c,294 :: 		if (__counter == 20)
	MOV	___counter, W0
	CP	W0, #20
	BRA Z	L__dd_GraphicController_onTimerInterrupt75
	GOTO	L_dd_GraphicController_onTimerInterrupt23
L__dd_GraphicController_onTimerInterrupt75:
;dd_graphic_controller.c,296 :: 		dSignalLed_unset(DSIGNAL_LED_RED_RIGHT);
	MOV.B	#1, W10
	CALL	_dSignalLed_unset
;dd_graphic_controller.c,297 :: 		__counter = 0;
	CLR	W0
	MOV	W0, ___counter
;dd_graphic_controller.c,298 :: 		}
L_dd_GraphicController_onTimerInterrupt23:
;dd_graphic_controller.c,300 :: 		__counter++;
	MOV	#1, W1
	MOV	#lo_addr(___counter), W0
	ADD	W1, [W0], [W0]
;dd_graphic_controller.c,302 :: 		if(dd_onStartup)
...
;dd_graphic_controller.c,304 :: 		dd_tmr1Counter++;
	MOV.B	#1, W1
	MOV	#lo_addr(_dd_tmr1Counter), W0
	ADD.B	W1, [W0], [W0]
;dd_graphic_controller.c,305 :: 		if(dd_tmr1Counter  >= dd_onStartupCounterLimit)
	MOV	#lo_addr(_dd_tmr1Counter), W0
	MOV.B	[W0], W1
...
;dd_graphic_controller.c,307 :: 		dd_onStartup = 0;
	MOV	#lo_addr(_dd_onStartup), W1
	CLR	W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,308 :: 		dd_tmr1Counter = 0;
	MOV	#lo_addr(_dd_tmr1Counter), W1
	CLR	W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,309 :: 		eGlcd_clear();
	CALL	_eGlcd_clear
;dd_graphic_controller.c,310 :: 		Lcd_PrintFrame();
	CALL	_Lcd_PrintFrame
...
;dd_graphic_controller.c,315 :: 		if(dd_isInterfaceChangedFromLastFrame)
...
;dd_graphic_controller.c,318 :: 		dd_Interface_print[dd_currentInterface]();
	...
	MOV	[W0], W0
	CALL	W0
;dd_graphic_controller.c,319 :: 		dd_printMessage(dd_currentInterfaceTitle);
	MOV	#lo_addr(_dd_currentInterfaceTitle), W10
	CALL	_dd_printMessage
;dd_graphic_controller.c,320 :: 		dd_isInterfaceChangedFromLastFrame = 0;
	MOV	#lo_addr(dd_graphic_controller_dd_isInterfaceChangedFromLastFrame), W1
	CLR	W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,321 :: 		Lcd_PrintFrame();
	CALL	_Lcd_PrintFrame
;dd_graphic_controller.c,322 :: 		}
	GOTO	L_dd_GraphicController_onTimerInterrupt28
L_dd_GraphicController_onTimerInterrupt27:
;dd_graphic_controller.c,323 :: 		else if (dd_onInterfaceChange)
...
;dd_graphic_controller.c,331 :: 		dd_tmr1Counter++;
	MOV.B	#1, W1
	MOV	#lo_addr(_dd_tmr1Counter), W0
	ADD.B	W1, [W0], [W0]
;dd_graphic_controller.c,332 :: 		if(dd_tmr1Counter  >= dd_onInterfaceChangeCounterLimit)
	MOV	#lo_addr(_dd_tmr1Counter), W0
	MOV.B	[W0], W1
...
;dd_graphic_controller.c,334 :: 		dd_onInterfaceChange = 0;
	MOV	#lo_addr(_dd_onInterfaceChange), W1
	CLR	W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,335 :: 		dd_tmr1Counter = 0;
	MOV	#lo_addr(_dd_tmr1Counter), W1
	CLR	W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,336 :: 		eGlcd_fill(WHITE);
	MOV.B	#_WHITE, W10
	CALL	_eGlcd_fill
...
;dd_graphic_controller.c,344 :: 		if (dd_notificationFlag) {
	MOV	#lo_addr(dd_graphic_controller_dd_notificationFlag), W0
	CP0.B	[W0]
...
;dd_graphic_controller.c,345 :: 		dd_GraphicController_handleNotification();
	CALL	_dd_GraphicController_handleNotification
;dd_graphic_controller.c,346 :: 		}
L_dd_GraphicController_onTimerInterrupt32:
;dd_graphic_controller.c,347 :: 		dd_Interface_print[dd_currentInterface]();
	MOV	#lo_addr(dd_graphic_controller_dd_currentInterface), W0
	ZE	[W0], W0
	SL	W0, #1, W1
	MOV	#lo_addr(_dd_Interface_print), W0
	...
	MOV	[W0], W0
	CALL	W0
;dd_graphic_controller.c,348 :: 		Lcd_PrintFrame();
	CALL	_Lcd_PrintFrame
;dd_graphic_controller.c,349 :: 		dd_isFrameUpdateForced = FALSE;
	MOV	#lo_addr(dd_graphic_controller_dd_isFrameUpdateForced), W1
	CLR	W0
	MOV.B	W0, [W1]
...
;dd_graphic_controller.c,356 :: 		clearTimer1();
	BCLR	IFS0bits, #3
;dd_graphic_controller.c,368 :: 		}
