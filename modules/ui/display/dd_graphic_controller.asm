...
;dd_graphic_controller.c,116 :: 		dd_currentInterface = interface;
	...
	MOV.B	W10, [W0]
;dd_graphic_controller.c,118 :: 		eGlcd_clear();
	CALL	_eGlcd_clear
;dd_graphic_controller.c,119 :: 		dd_Interface_print[dd_currentInterface]();
	MOV	#lo_addr(dd_graphic_controller_dd_currentInterface), W0
	ZE	[W0], W0
	SL	W0, #1, W1
	...
	MOV	[W0], W0
	CALL	W0
;dd_graphic_controller.c,120 :: 		dd_GraphicController_fireTimedNotification(OP_MODE_POPUP_PERIOD, dd_currentInterfaceTitle, MESSAGE);
	CLR	W12
...
;dd_graphic_controller.c,126 :: 		void dd_GraphicController_setCollectionInterface(Interface interface, Indicator** indicator_collection, unsigned char indicator_count, char* title) {
;dd_graphic_controller.c,128 :: 		dd_GraphicController_setInterface(interface);
	PUSH	W10
	PUSH.D	W12
	PUSH	W11
	CALL	_dd_GraphicController_setInterface
;dd_graphic_controller.c,130 :: 		dd_Interface_init[dd_currentInterface]();
	MOV	#lo_addr(dd_graphic_controller_dd_currentInterface), W0
	ZE	[W0], W0
	SL	W0, #1, W1
	...
	POP	W11
	POP.D	W12
;dd_graphic_controller.c,131 :: 		if ( strlen(title) < MAX_INTERFACE_TITLE_LENGTH )
	MOV	W13, W10
	CALL	_strlen
	CP	W0, #20
...
;dd_graphic_controller.c,132 :: 		strcpy(dd_currentInterfaceTitle, title);
	PUSH	W11
	MOV	W13, W11
...
;dd_graphic_controller.c,133 :: 		dd_currentIndicators = indicator_collection;
	MOV	W11, _dd_currentIndicators
;dd_graphic_controller.c,134 :: 		dd_currentIndicatorsCount = indicator_count;
...
;dd_graphic_controller.c,141 :: 		Interface dd_GraphicController_getInterface(void) {
;dd_graphic_controller.c,142 :: 		return dd_currentInterface;
	MOV	#lo_addr(dd_graphic_controller_dd_currentInterface), W0
	MOV.B	[W0], W0
...
;dd_graphic_controller.c,145 :: 		void dd_GraphicController_saveCurrentInterface(void) {
;dd_graphic_controller.c,146 :: 		strcpy(dd_lastInterfaceTitle, dd_currentInterfaceTitle);
	PUSH	W10
	PUSH	W11
	MOV	#lo_addr(_dd_currentInterfaceTitle), W11
	MOV	#lo_addr(dd_graphic_controller_dd_lastInterfaceTitle), W10
	CALL	_strcpy
;dd_graphic_controller.c,147 :: 		dd_lastInterface = dd_currentInterface;
...
;dd_graphic_controller.c,168 :: 		Lcd_PrintFrame();
...
;dd_graphic_controller.c,174 :: 		void dd_GraphicController_fireTimedNotification(unsigned int time, char *text, NotificationType type) {
;dd_graphic_controller.c,175 :: 		dd_notificationTimeoutCounter = dd_GraphicController_getTmrCounterLimit(time);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W11
...
;dd_graphic_controller.c,176 :: 		dd_notificationIsTimed = 1;
	MOV	#lo_addr(_dd_notificationIsTimed), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,177 :: 		dd_GraphicController_fireNotification(text, type);
	MOV	W11, W10
	MOV.B	W12, W11
...
;dd_graphic_controller.c,180 :: 		void dd_GraphicController_firePromptNotification(char *text) {
;dd_graphic_controller.c,181 :: 		if(dd_notificationFlag)
	PUSH	W11
...
;dd_graphic_controller.c,184 :: 		eGlcd_clear();
	PUSH	W10
	CALL	_eGlcd_clear
	POP	W10
L_dd_GraphicController_firePromptNotification3:
;dd_graphic_controller.c,186 :: 		dd_notificationIsTimed = 0;
	MOV	#lo_addr(_dd_notificationIsTimed), W1
	CLR	W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,187 :: 		dd_GraphicController_fireNotification(text, PROMPT);
	MOV.B	#3, W11
	CALL	_dd_GraphicController_fireNotification
...
;dd_graphic_controller.c,190 :: 		void dd_GraphicController_clearPrompt()
...
;dd_graphic_controller.c,195 :: 		void dd_GraphicController_handleNotification(void) {
;dd_graphic_controller.c,196 :: 		if (dd_notificationTimeoutCounter > 0) {
...
;dd_graphic_controller.c,197 :: 		dd_notificationTimeoutCounter--;
	MOV	#1, W1
...
;dd_graphic_controller.c,199 :: 		dd_GraphicController_clearNotification();
	CALL	_dd_GraphicController_clearNotification
...
;dd_graphic_controller.c,227 :: 		void dd_GraphicController_forceFullFrameUpdate(void) {              //inutile
;dd_graphic_controller.c,228 :: 		dd_isFrameUpdateForced = TRUE;
	MOV	#lo_addr(dd_graphic_controller_dd_isFrameUpdateForced), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
...
;dd_graphic_controller.c,231 :: 		void dd_GraphicController_releaseFullFrameUpdate(void) {
;dd_graphic_controller.c,232 :: 		dd_isFrameUpdateForced = FALSE;
	MOV	#lo_addr(dd_graphic_controller_dd_isFrameUpdateForced), W1
	CLR	W0
	MOV.B	W0, [W1]
...
;dd_graphic_controller.c,235 :: 		void dd_GraphicController_forceNextFrameUpdate(void) {
;dd_graphic_controller.c,236 :: 		dd_isNextFrameUpdateForced = TRUE;
...
;dd_graphic_controller.c,239 :: 		char dd_GraphicController_isFrameUpdateForced(void) {
;dd_graphic_controller.c,240 :: 		return dd_isFrameUpdateForced;
...
;dd_graphic_controller.c,243 :: 		void dd_GraphicController_queueColorInversion(void) {
;dd_graphic_controller.c,244 :: 		dd_isColorInversionQueued = TRUE;
...
;dd_graphic_controller.c,247 :: 		char dd_GraphicController_isColorInversionQueued(void) {               //inutile
;dd_graphic_controller.c,248 :: 		return dd_isColorInversionQueued;
...
;dd_graphic_controller.c,251 :: 		void dd_printLogoAnimation() {
;dd_graphic_controller.c,252 :: 		char page = 0;
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
;dd_graphic_controller.c,253 :: 		int i =0, j=0, k=0;
;dd_graphic_controller.c,254 :: 		signed char new_y = 0;
;dd_graphic_controller.c,255 :: 		signed char old_y = 0;
;dd_graphic_controller.c,256 :: 		int y_center = 19;
	MOV	#19, W0
	MOV	W0, [W14+8]
;dd_graphic_controller.c,258 :: 		signed char new_y_border = 0;
;dd_graphic_controller.c,260 :: 		eGlcd_LoadImage(DYNAMIS_LOGO);
	MOV	#lo_addr(dd_graphic_controller_DYNAMIS_LOGO), W10
	CALL	_eGlcd_loadImage
;dd_graphic_controller.c,264 :: 		for (k=5; k<=120; k++){
	MOV	#5, W0
	MOV	W0, [W14+4]
...
;dd_graphic_controller.c,265 :: 		resetTimer32();
	CALL	_resetTimer32
;dd_graphic_controller.c,266 :: 		cos_angle = cos(0.10466*k);
	MOV	[W14+4], W0
	ASR	W0, #15, W1
	SETM	W2
	CALL	__Long2Float
	...
	MOV	W0, [W14+0]
	MOV	W1, [W14+2]
;dd_graphic_controller.c,267 :: 		new_y_border = round((cos_angle*17));
	MOV	#0, W2
	MOV	#16776, W3
	CALL	__Mul_FP
	MOV.D	W0, W10
	CALL	_round
	MOV.B	W0, [W14+10]
;dd_graphic_controller.c,268 :: 		if (new_y_border<0) new_y_border = -new_y_border;
	CP.B	W0, #0
...
;dd_graphic_controller.c,269 :: 		for (i=0; i<=17-new_y_border; i++)
...
;dd_graphic_controller.c,271 :: 		for (j=0; j<8; j++)
...
;dd_graphic_controller.c,273 :: 		frameBuff[j*64+i] = 0xFF;
	SL	W2, #6, W0
	ADD	W0, W8, W1
	...
	MOV.B	#255, W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,274 :: 		frameBuff[j*64+i+y_center+new_y_border] = 0xFF;
	SL	W2, #6, W0
	ADD	W0, W8, W1
	ADD	W14, #8, W0
	ADD	W1, [W0], W1
...
;dd_graphic_controller.c,277 :: 		for (new_y=-new_y_border; new_y<=new_y_border; new_y++)
	MOV.B	[W14+10], W1
	ADD	W14, #6, W0
	SUBR.B	W1, #0, [W0]
...
;dd_graphic_controller.c,279 :: 		old_y = round(new_y/cos_angle);
	ADD	W14, #6, W2
	SE	[W2], W0
	ASR	W0, #15, W1
	SETM	W2
...
; old_y start address is: 12 (W6)
	MOV.B	W0, W6
;dd_graphic_controller.c,280 :: 		for (page = 0; page<8; page++)
...
; old_y end address is: 12 (W6)
;dd_graphic_controller.c,282 :: 		i = page*2*64+old_y+y_center;
; old_y start address is: 12 (W6)
	ZE	W4, W0
	SL	W0, #1, W0
	SL	W0, #6, W1
	...
	ADD	W14, #8, W0
	ADD	W1, [W0], W3
;dd_graphic_controller.c,283 :: 		j = page*64+new_y+y_center;
	ZE	W4, W0
	SL	W0, #6, W1
	ADD	W14, #6, W0
	SE	[W0], W0
	...
	ADD	W14, #8, W0
	ADD	W1, [W0], W1
;dd_graphic_controller.c,284 :: 		frameBuff[j] = DYNAMIS_LOGO[i];
	MOV	#lo_addr(_frameBuff), W0
	ADD	W1, [W0], W2
...
;dd_graphic_controller.c,287 :: 		Lcd_PrintFrame();
	CALL	_Lcd_PrintFrame
;dd_graphic_controller.c,288 :: 		Delay_Cyc(floor(pow(k*8,2)/30000+new_y_border/10), k*700);
	MOV	[W14+4], W1
	MOV	#700, W0
	MUL.SS	W1, W0, W0
	MOV	W0, [W14+22]
...
;dd_graphic_controller.c,293 :: 		void dd_GraphicController_onTimerInterrupt(void)
;dd_graphic_controller.c,298 :: 		if ( __counter == 10 )
	PUSH	W10
	MOV	___counter, W0
	CP	W0, #10
...
;dd_graphic_controller.c,300 :: 		dSignalLed_set(DSIGNAL_LED_RED_RIGHT);
	MOV.B	#1, W10
	CALL	_dSignalLed_set
;dd_graphic_controller.c,301 :: 		}
L_dd_GraphicController_onTimerInterrupt22:
;dd_graphic_controller.c,302 :: 		if (__counter == 20)
	MOV	___counter, W0
	CP	W0, #20
...
;dd_graphic_controller.c,304 :: 		dSignalLed_unset(DSIGNAL_LED_RED_RIGHT);
	MOV.B	#1, W10
	CALL	_dSignalLed_unset
;dd_graphic_controller.c,305 :: 		__counter = 0;
	CLR	W0
	MOV	W0, ___counter
;dd_graphic_controller.c,306 :: 		}
L_dd_GraphicController_onTimerInterrupt23:
;dd_graphic_controller.c,308 :: 		__counter++;
	MOV	#1, W1
	MOV	#lo_addr(___counter), W0
	ADD	W1, [W0], [W0]
;dd_graphic_controller.c,310 :: 		if(dd_onStartup)
...
;dd_graphic_controller.c,312 :: 		dd_tmr1Counter++;
	MOV.B	#1, W1
	MOV	#lo_addr(_dd_tmr1Counter), W0
	ADD.B	W1, [W0], [W0]
;dd_graphic_controller.c,313 :: 		if(dd_tmr1Counter  >= dd_onStartupCounterLimit)
	MOV	#lo_addr(_dd_tmr1Counter), W0
	MOV.B	[W0], W1
...
;dd_graphic_controller.c,315 :: 		dd_onStartup = 0;
	MOV	#lo_addr(_dd_onStartup), W1
	CLR	W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,316 :: 		dd_tmr1Counter = 0;
	MOV	#lo_addr(_dd_tmr1Counter), W1
	CLR	W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,317 :: 		eGlcd_clear();
	CALL	_eGlcd_clear
;dd_graphic_controller.c,318 :: 		Lcd_PrintFrame();
	CALL	_Lcd_PrintFrame
...
;dd_graphic_controller.c,323 :: 		if (dd_notificationFlag) {
	MOV	#lo_addr(dd_graphic_controller_dd_notificationFlag), W0
	CP0.B	[W0]
...
;dd_graphic_controller.c,324 :: 		if(dd_notificationIsTimed)
...
;dd_graphic_controller.c,325 :: 		dd_GraphicController_handleNotification();
...
;dd_graphic_controller.c,328 :: 		eGlcd_clear();
	CALL	_eGlcd_clear
...
;dd_graphic_controller.c,371 :: 		clearTimer1();
	BCLR	IFS0bits, #3
;dd_graphic_controller.c,383 :: 		}
