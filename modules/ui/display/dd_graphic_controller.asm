...
;dd_graphic_controller.c,143 :: 		void dd_GraphicController_setNotificationFlag (void){
;dd_graphic_controller.c,144 :: 		dd_notificationFlag = TRUE;
...
;dd_graphic_controller.c,147 :: 		void dd_GraphicController_unsetNotificationFlag (void){
;dd_graphic_controller.c,148 :: 		dd_notificationFlag = FALSE;
	MOV	#lo_addr(dd_graphic_controller_dd_notificationFlag), W1
	CLR	W0
	MOV.B	W0, [W1]
...
;dd_graphic_controller.c,151 :: 		void dd_GraphicController_clearNotification(void) {
;dd_graphic_controller.c,152 :: 		eGlcd_clear();
	CALL	_eGlcd_clear
;dd_graphic_controller.c,153 :: 		dd_isFrameUpdateForced = TRUE;
	MOV	#lo_addr(dd_graphic_controller_dd_isFrameUpdateForced), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,154 :: 		dd_GraphicController_unsetNotificationFlag();
...
;dd_graphic_controller.c,157 :: 		void dd_GraphicController_fireNotification(char *text, NotificationType type) {
;dd_graphic_controller.c,158 :: 		strcpy(dd_notificationText, text);
	PUSH	W10
	PUSH	W11
	MOV	W10, W11
	MOV	#lo_addr(_dd_notificationText), W10
	CALL	_strcpy
;dd_graphic_controller.c,159 :: 		dd_printMessage(dd_notificationText);
	MOV	#lo_addr(_dd_notificationText), W10
	CALL	_dd_printMessage
;dd_graphic_controller.c,160 :: 		dd_GraphicController_setNotificationFlag();
...
;dd_graphic_controller.c,166 :: 		void dd_GraphicController_fireTimedNotification(unsigned int time, char *text, NotificationType type) {
;dd_graphic_controller.c,167 :: 		dd_notificationTimeoutCounter = dd_GraphicController_getTmrCounterLimit(time);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W11
...
;dd_graphic_controller.c,168 :: 		dd_GraphicController_fireNotification(text, type);
	MOV	W11, W10
	MOV.B	W12, W11
...
;dd_graphic_controller.c,171 :: 		void dd_GraphicController_handleNotification(void) {
;dd_graphic_controller.c,172 :: 		if (dd_notificationTimeoutCounter > 0) {
...
;dd_graphic_controller.c,173 :: 		dd_notificationTimeoutCounter--;
	MOV	#1, W1
	MOV	#lo_addr(_dd_notificationTimeoutCounter), W0
	SUBR	W1, [W0], [W0]
;dd_graphic_controller.c,174 :: 		if (dd_notificationTimeoutCounter == 0) {
	MOV	_dd_notificationTimeoutCounter, W0
	CP	W0, #0
...
;dd_graphic_controller.c,227 :: 		void dd_printLogoAnimation() {
;dd_graphic_controller.c,228 :: 		char page = 0;
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
;dd_graphic_controller.c,229 :: 		int i =0, j=0, k=0;
;dd_graphic_controller.c,230 :: 		signed char new_y = 0;
;dd_graphic_controller.c,231 :: 		signed char old_y = 0;
;dd_graphic_controller.c,232 :: 		int y_center = 19;
	MOV	#19, W0
	MOV	W0, [W14+8]
;dd_graphic_controller.c,234 :: 		signed char new_y_border = 0;
;dd_graphic_controller.c,236 :: 		eGlcd_LoadImage(DYNAMIS_LOGO);
	MOV	#lo_addr(dd_graphic_controller_DYNAMIS_LOGO), W10
	CALL	_eGlcd_loadImage
;dd_graphic_controller.c,240 :: 		for (k=5; k<=120; k++){
	MOV	#5, W0
	MOV	W0, [W14+4]
...
;dd_graphic_controller.c,241 :: 		resetTimer32();
	CALL	_resetTimer32
;dd_graphic_controller.c,242 :: 		cos_angle = cos(0.10466*k);
	MOV	[W14+4], W0
	ASR	W0, #15, W1
	SETM	W2
	CALL	__Long2Float
	...
	MOV	W0, [W14+0]
	MOV	W1, [W14+2]
;dd_graphic_controller.c,243 :: 		new_y_border = round((cos_angle*17));
	MOV	#0, W2
	MOV	#16776, W3
	CALL	__Mul_FP
	MOV.D	W0, W10
	CALL	_round
	MOV.B	W0, [W14+10]
;dd_graphic_controller.c,244 :: 		if (new_y_border<0) new_y_border = -new_y_border;
	CP.B	W0, #0
...
;dd_graphic_controller.c,245 :: 		for (i=0; i<=17-new_y_border; i++)
...
;dd_graphic_controller.c,247 :: 		for (j=0; j<8; j++)
...
;dd_graphic_controller.c,249 :: 		frameBuff[j*64+i] = 0xFF;
	SL	W2, #6, W0
	ADD	W0, W8, W1
	...
	MOV.B	#255, W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,250 :: 		frameBuff[j*64+i+y_center+new_y_border] = 0xFF;
	SL	W2, #6, W0
	ADD	W0, W8, W1
	ADD	W14, #8, W0
	ADD	W1, [W0], W1
...
;dd_graphic_controller.c,253 :: 		for (new_y=-new_y_border; new_y<=new_y_border; new_y++)
	MOV.B	[W14+10], W1
	ADD	W14, #6, W0
	SUBR.B	W1, #0, [W0]
...
;dd_graphic_controller.c,255 :: 		old_y = round(new_y/cos_angle);
	ADD	W14, #6, W2
	SE	[W2], W0
	ASR	W0, #15, W1
	SETM	W2
...
; old_y start address is: 12 (W6)
	MOV.B	W0, W6
;dd_graphic_controller.c,256 :: 		for (page = 0; page<8; page++)
...
; old_y end address is: 12 (W6)
;dd_graphic_controller.c,258 :: 		i = page*2*64+old_y+y_center;
; old_y start address is: 12 (W6)
	ZE	W4, W0
	SL	W0, #1, W0
	SL	W0, #6, W1
	...
	ADD	W14, #8, W0
	ADD	W1, [W0], W3
;dd_graphic_controller.c,259 :: 		j = page*64+new_y+y_center;
	ZE	W4, W0
	SL	W0, #6, W1
	ADD	W14, #6, W0
	SE	[W0], W0
	...
	ADD	W14, #8, W0
	ADD	W1, [W0], W1
;dd_graphic_controller.c,260 :: 		frameBuff[j] = DYNAMIS_LOGO[i];
	MOV	#lo_addr(_frameBuff), W0
	ADD	W1, [W0], W2
...
;dd_graphic_controller.c,263 :: 		Lcd_PrintFrame();
	CALL	_Lcd_PrintFrame
;dd_graphic_controller.c,264 :: 		Delay_Cyc(floor(pow(k*8,2)/30000+new_y_border/10), k*700);
	MOV	[W14+4], W1
	MOV	#700, W0
	MUL.SS	W1, W0, W0
	MOV	W0, [W14+22]
...
;dd_graphic_controller.c,269 :: 		void dd_GraphicController_onTimerInterrupt(void)
;dd_graphic_controller.c,271 :: 		if ( __counter == 10 )
	PUSH	W10
	MOV	___counter, W0
	CP	W0, #10
...
;dd_graphic_controller.c,273 :: 		dSignalLed_set(DSIGNAL_LED_RED_RIGHT);
	MOV.B	#1, W10
	CALL	_dSignalLed_set
;dd_graphic_controller.c,274 :: 		}
L_dd_GraphicController_onTimerInterrupt20:
;dd_graphic_controller.c,275 :: 		if (__counter == 20)
	MOV	___counter, W0
	CP	W0, #20
...
;dd_graphic_controller.c,277 :: 		dSignalLed_unset(DSIGNAL_LED_RED_RIGHT);
	MOV.B	#1, W10
	CALL	_dSignalLed_unset
;dd_graphic_controller.c,278 :: 		__counter = 0;
	CLR	W0
	MOV	W0, ___counter
;dd_graphic_controller.c,279 :: 		}
L_dd_GraphicController_onTimerInterrupt21:
;dd_graphic_controller.c,281 :: 		__counter++;
	MOV	#1, W1
	MOV	#lo_addr(___counter), W0
	ADD	W1, [W0], [W0]
;dd_graphic_controller.c,283 :: 		if(dd_onStartup)
...
;dd_graphic_controller.c,285 :: 		dd_tmr1Counter++;
	MOV.B	#1, W1
	MOV	#lo_addr(_dd_tmr1Counter), W0
	ADD.B	W1, [W0], [W0]
;dd_graphic_controller.c,286 :: 		if(dd_tmr1Counter  >= dd_onStartupCounterLimit)
	MOV	#lo_addr(_dd_tmr1Counter), W0
	MOV.B	[W0], W1
	MOV	#lo_addr(_dd_onStartupCounterLimit), W0
	CP.B	W1, [W0]
	BRA GEU	L__dd_GraphicController_onTimerInterrupt72
	GOTO	L_dd_GraphicController_onTimerInterrupt23
L__dd_GraphicController_onTimerInterrupt72:
;dd_graphic_controller.c,288 :: 		dd_onStartup = 0;
	MOV	#lo_addr(_dd_onStartup), W1
	CLR	W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,289 :: 		dd_tmr1Counter = 0;
	MOV	#lo_addr(_dd_tmr1Counter), W1
	CLR	W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,290 :: 		eGlcd_clear();
	CALL	_eGlcd_clear
;dd_graphic_controller.c,291 :: 		Lcd_PrintFrame();
	CALL	_Lcd_PrintFrame
...
;dd_graphic_controller.c,296 :: 		if(dd_isInterfaceChangedFromLastFrame)
...
;dd_graphic_controller.c,298 :: 		eGlcd_clear();
	CALL	_eGlcd_clear
;dd_graphic_controller.c,299 :: 		dd_Interface_print[dd_currentInterface]();
	MOV	#lo_addr(dd_graphic_controller_dd_currentInterface), W0
	ZE	[W0], W0
	SL	W0, #1, W1
	...
	MOV	[W0], W0
	CALL	W0
;dd_graphic_controller.c,300 :: 		dd_printMessage(dd_currentInterfaceTitle);
	MOV	#lo_addr(_dd_currentInterfaceTitle), W10
	CALL	_dd_printMessage
;dd_graphic_controller.c,301 :: 		dd_isInterfaceChangedFromLastFrame = 0;
	MOV	#lo_addr(dd_graphic_controller_dd_isInterfaceChangedFromLastFrame), W1
	CLR	W0
	MOV.B	W0, [W1]
...
;dd_graphic_controller.c,304 :: 		else if (dd_onInterfaceChange)
...
;dd_graphic_controller.c,312 :: 		dd_tmr1Counter++;
	...
	MOV	#lo_addr(_dd_tmr1Counter), W0
	ADD.B	W1, [W0], [W0]
;dd_graphic_controller.c,313 :: 		if(dd_tmr1Counter  >= dd_onInterfaceChangeCounterLimit)
	MOV	#lo_addr(_dd_tmr1Counter), W0
	MOV.B	[W0], W1
	MOV	#lo_addr(_dd_onInterfaceChangeCounterLimit), W0
	CP.B	W1, [W0]
	BRA GEU	L__dd_GraphicController_onTimerInterrupt75
	GOTO	L_dd_GraphicController_onTimerInterrupt28
L__dd_GraphicController_onTimerInterrupt75:
;dd_graphic_controller.c,315 :: 		dd_onInterfaceChange = 0;
	MOV	#lo_addr(_dd_onInterfaceChange), W1
	CLR	W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,316 :: 		dd_tmr1Counter = 0;
	...
	CLR	W0
	MOV.B	W0, [W1]
;dd_graphic_controller.c,317 :: 		eGlcd_fill(WHITE);
	MOV.B	#_WHITE, W10
	CALL	_eGlcd_fill
...
;dd_graphic_controller.c,325 :: 		if (dd_notificationFlag) {
...
;dd_graphic_controller.c,326 :: 		dd_GraphicController_handleNotification();
...
;dd_graphic_controller.c,337 :: 		clearTimer1();
	BCLR	IFS0bits, #3
;dd_graphic_controller.c,349 :: 		}
