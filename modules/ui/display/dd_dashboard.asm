...
;dd_dashboard.c,124 :: 		dd_Indicator_drawContainers(indicatorIndex);
	PUSH	W10
	CALL	_dd_Indicator_drawContainers
	POP	W10
;dd_dashboard.c,125 :: 		x = dd_Indicator_getNameXCoord(indicatorIndex);
	CALL	_dd_Indicator_getNameXCoord
	MOV.B	W0, [W14+2]
;dd_dashboard.c,126 :: 		y = dd_Indicator_getNameYCoord(indicatorIndex);
	CALL	_dd_Indicator_getNameYCoord
	MOV.B	W0, [W14+3]
;dd_dashboard.c,127 :: 		eGlcd_setFont(DD_xTerminal_Font);
	PUSH	W10
	MOV	#32, W13
	MOV.B	#8, W12
	MOV.B	#6, W11
	...
	CALL	_xGlcd_Set_Font
;dd_dashboard.c,128 :: 		eGlcd_writeText(indicator->name, x, y);
	MOV	[W14+0], W0
	INC2	W0
	MOV.B	[W14+3], W12
	MOV.B	[W14+2], W11
...
;dd_dashboard.c,129 :: 		eGlcd_setFont(DD_Dashboard_Font);
	MOV	#32, W13
	MOV.B	#16, W12
	MOV.B	#16, W11
