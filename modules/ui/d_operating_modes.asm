...
;d_operating_modes.c,143 :: 		void d_UI_CruiseModeInit() {
;d_operating_modes.c,144 :: 		dd_GraphicController_setCollectionInterface(DASHBOARD_INTERFACE, dd_carParameters, dd_carParametersCount, "Race");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,147 :: 		void d_UI_AccModeInit(){
;d_operating_modes.c,148 :: 		dd_GraphicController_setCollectionInterface(DASHBOARD_INTERFACE, dd_carParameters, dd_carParametersCount, "Acceleration");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,151 :: 		void d_UI_DebugModeInit() {
;d_operating_modes.c,152 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_carParameters, dd_carParametersCount, "Debug");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,155 :: 		void d_UI_BoardDebugModeInit() {
;d_operating_modes.c,156 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_carBoards, dd_carBoardsCount, "Boards");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,159 :: 		void d_UI_AutocrossModeInit() {
;d_operating_modes.c,160 :: 		dd_GraphicController_setCollectionInterface(DASHBOARD_INTERFACE, dd_carParameters, dd_carParametersCount, "Autocross");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,164 :: 		void d_UI_CruiseModeClose(){
...
;d_operating_modes.c,167 :: 		void d_UI_AccModeClose(){
;d_operating_modes.c,168 :: 		dAcc_stopAutoAccelerationFromSW();
	CALL	_dAcc_stopAutoAccelerationFromSW
;d_operating_modes.c,169 :: 		}
...
;d_operating_modes.c,171 :: 		void d_UI_DebugModeClose(){
...
;d_operating_modes.c,174 :: 		void d_UI_BoardDebugModeClose(){
...
;d_operating_modes.c,177 :: 		void d_UI_AutocrossModeClose(){
;d_operating_modes.c,178 :: 		dAutocross_stopAutocrossFromSW();
	CALL	_dAutocross_stopAutocrossFromSW
;d_operating_modes.c,179 :: 		}
...
;d_operating_modes.c,229 :: 		void d_DashboardSetting_updateValue(IntegerIndicator* ind, int val) {
;d_operating_modes.c,230 :: 		ind->value = val;
	PUSH	W11
	ADD	W10, #20, W0
	MOV	W11, [W0]
;d_operating_modes.c,231 :: 		strcpy(ind->base.label, dd_carParameters[ind->value]->name);
	ADD	W10, #20, W0
	MOV	[W0], W0
	SL	W0, #1, W1
	...
	CALL	_strcpy
	POP	W10
;d_operating_modes.c,232 :: 		ind->base.labelLength = dd_carParameters[ind->value]->nameLength;
	ADD	W10, #9, W2
	ADD	W10, #20, W0
	MOV	[W0], W0
	SL	W0, #1, W1
	...
	ADD	W0, #6, W0
	MOV.B	[W0], [W2]
;d_operating_modes.c,233 :: 		ind->base.pendingPrintUpdate = TRUE;
	ADD	W10, #8, W1
	MOV.B	[W1], W0
	XOR.B	W0, #1, W0
	AND.B	W0, #3, W0
...
;d_operating_modes.c,236 :: 		void d_UI_SettingsModeInit() {
;d_operating_modes.c,239 :: 		d_DashboardSetting_updateValue(&sett_dash_top_left, TOP_LEFT);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,240 :: 		d_DashboardSetting_updateValue(&sett_dash_top_right, TOP_RIGHT);
	MOV	#1, W11
	MOV	#lo_addr(_sett_dash_top_right), W10
	CALL	_d_DashboardSetting_updateValue
;d_operating_modes.c,241 :: 		d_DashboardSetting_updateValue(&sett_dash_bottom_right, BOTTOM_RIGHT);
	MOV	#2, W11
	MOV	#lo_addr(_sett_dash_bottom_right), W10
	CALL	_d_DashboardSetting_updateValue
;d_operating_modes.c,242 :: 		d_DashboardSetting_updateValue(&sett_dash_bottom_left, BOTTOM_LEFT);
	MOV	#3, W11
	MOV	#lo_addr(_sett_dash_bottom_left), W10
	CALL	_d_DashboardSetting_updateValue
;d_operating_modes.c,244 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_settings, dd_settingsCount, "Settings");
...
;d_operating_modes.c,251 :: 		void d_UI_onSettingsChange(signed char movements) {
;d_operating_modes.c,254 :: 		Indicator* settingIndicator = dd_settings[dd_Menu_selectedLine()];
	PUSH	W10
	PUSH	W11
	PUSH	W10
	...
	MOV	[W0], W0
	MOV	W0, [W14+0]
;d_operating_modes.c,256 :: 		switch (settingIndicator->id) {
	MOV	W0, [W14+4]
	GOTO	L_d_UI_onSettingsChange0
;d_operating_modes.c,257 :: 		case S_INVERT_COLORS:
L_d_UI_onSettingsChange2:
;d_operating_modes.c,258 :: 		dd_GraphicController_invertColors();
	CALL	_dd_GraphicController_invertColors
;d_operating_modes.c,259 :: 		dd_Indicator_switchBoolValueP(&sett_invert_colors.base);
	MOV	#lo_addr(_sett_invert_colors), W10
	CALL	_dd_Indicator_switchBoolValueP
;d_operating_modes.c,260 :: 		settingIndicator->pendingPrintUpdate = TRUE;
	MOV	[W14+0], W0
	ADD	W0, #8, W1
	MOV.B	[W1], W0
	XOR.B	W0, #1, W0
	...
	XOR.B	W0, [W1], W0
	MOV.B	W0, [W1]
;d_operating_modes.c,261 :: 		return;
	GOTO	L_end_d_UI_onSettingsChange
;d_operating_modes.c,262 :: 		case S_BYPASS_GEARS:
L_d_UI_onSettingsChange3:
;d_operating_modes.c,263 :: 		if (dGear_isShiftingCheckBypassed()) {
...
;d_operating_modes.c,264 :: 		dGear_enableShiftCheck();
	CALL	_dGear_enableShiftCheck
;d_operating_modes.c,265 :: 		dd_Indicator_setBoolValueP(&sett_bypass_gears.base, FALSE);
	CLR	W11
...
;d_operating_modes.c,266 :: 		settingIndicator->pendingPrintUpdate = TRUE;
	...
	XOR.B	W0, [W1], W0
	MOV.B	W0, [W1]
;d_operating_modes.c,267 :: 		} else {
	GOTO	L_d_UI_onSettingsChange5
L_d_UI_onSettingsChange4:
;d_operating_modes.c,268 :: 		dGear_disableShiftCheck();
	CALL	_dGear_disableShiftCheck
;d_operating_modes.c,269 :: 		dd_Indicator_setBoolValueP(&sett_bypass_gears.base, TRUE);
	MOV.B	#1, W11
	MOV	#lo_addr(_sett_bypass_gears), W10
	CALL	_dd_Indicator_setBoolValueP
;d_operating_modes.c,270 :: 		settingIndicator->pendingPrintUpdate = TRUE;
	MOV	[W14+0], W0
	ADD	W0, #8, W1
	MOV.B	[W1], W0
	XOR.B	W0, #1, W0
...
;d_operating_modes.c,272 :: 		return;
	GOTO	L_end_d_UI_onSettingsChange
;d_operating_modes.c,273 :: 		default:
L_d_UI_onSettingsChange6:
;d_operating_modes.c,274 :: 		break;
...
;d_operating_modes.c,282 :: 		dashboardIndicatorIndex = ((IntegerIndicator*)settingIndicator)->value;
	MOV	[W14+0], W0
	ADD	W0, #20, W0
; dashboardIndicatorIndex start address is: 8 (W4)
	MOV	[W0], W4
;d_operating_modes.c,283 :: 		if (movements) {
	CP0.B	W10
	BRA NZ	L__d_UI_onSettingsChange33
	GOTO	L__d_UI_onSettingsChange16
L__d_UI_onSettingsChange33:
;d_operating_modes.c,284 :: 		dashboardIndicatorIndex+=movements;
	SE	W10, W0
	ADD	W4, W0, W0
; dashboardIndicatorIndex end address is: 8 (W4)
; dashboardIndicatorIndex start address is: 2 (W1)
	MOV	W0, W1
;d_operating_modes.c,285 :: 		if (dashboardIndicatorIndex >= dd_carParametersCount) {
	CP	W0, #25
	BRA GE	L__d_UI_onSettingsChange34
	GOTO	L_d_UI_onSettingsChange8
L__d_UI_onSettingsChange34:
;d_operating_modes.c,286 :: 		dashboardIndicatorIndex -= dd_carParametersCount;
...
;d_operating_modes.c,288 :: 		else if (dashboardIndicatorIndex < 0) {
; dashboardIndicatorIndex start address is: 2 (W1)
	CP	W1, #0
...
;d_operating_modes.c,292 :: 		d_DashboardSetting_updateValue((IntegerIndicator*)settingIndicator, dashboardIndicatorIndex);
; dashboardIndicatorIndex start address is: 0 (W0)
	MOV	W0, W11
; dashboardIndicatorIndex end address is: 0 (W0)
	MOV	[W14+0], W10
...
;d_operating_modes.c,303 :: 		void d_UI_ApplySettings() {
;d_operating_modes.c,307 :: 		for (i=0; i<dd_dashboardSettingsCount; i++) {
...
;d_operating_modes.c,308 :: 		setting = (IntegerIndicator*)dd_dashboardSettings[i];
	ZE	W3, W0
	SL	W0, #1, W2
...
; setting start address is: 8 (W4)
	MOV	[W1], W4
;d_operating_modes.c,309 :: 		oldIndicator = dd_carParameters[i];
	MOV	#lo_addr(d_operating_modes_dd_carParameters), W0
	ADD	W0, W2, W2
; oldIndicator start address is: 10 (W5)
	MOV	[W2], W5
;d_operating_modes.c,310 :: 		dd_carParameters[i] = dd_carParameters[setting->value];
	MOV	[W1], W0
	ADD	W0, #20, W0
	MOV	[W0], W0
	SL	W0, #1, W1
	...
	ADD	W0, W1, W0
	MOV	[W0], [W2]
;d_operating_modes.c,311 :: 		dd_carParameters[setting->value] = oldIndicator;
	ADD	W4, #20, W0
...
;d_operating_modes.c,313 :: 		if (dd_GraphicController_isColorInversionQueued){
...
;d_operating_modes.c,318 :: 		void d_UI_SettingsModeClose() {
;d_operating_modes.c,319 :: 		d_UI_ApplySettings();
	CALL	_d_UI_ApplySettings
;d_operating_modes.c,320 :: 		}
