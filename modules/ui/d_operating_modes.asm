...
;d_operating_modes.c,145 :: 		void d_UI_DebugModeInit() {
;d_operating_modes.c,146 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_carParameters, dd_carParametersCount, "Debug");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,149 :: 		void d_UI_BoardDebugModeInit() {
;d_operating_modes.c,150 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_carBoards, dd_carBoardsCount, "Boards");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
	MOV	#lo_addr(?lstr76_d_operating_modes), W13
	MOV.B	#13, W12
...
;d_operating_modes.c,153 :: 		void d_UI_AutocrossModeInit() {
;d_operating_modes.c,154 :: 		dd_GraphicController_setCollectionInterface(DASHBOARD_INTERFACE, dd_carParameters, dd_carParametersCount, "Autocross");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,158 :: 		void d_UI_CruiseModeClose(){
...
;d_operating_modes.c,161 :: 		void d_UI_AccModeClose(){
;d_operating_modes.c,162 :: 		dAcc_stopAutoAccelerationFromSW();
...
;d_operating_modes.c,165 :: 		void d_UI_DebugModeClose(){
...
;d_operating_modes.c,168 :: 		void d_UI_BoardDebugModeClose(){
...
;d_operating_modes.c,171 :: 		void d_UI_AutocrossModeClose(){
;d_operating_modes.c,172 :: 		dAutocross_stopAutocrossFromSW();
	CALL	_dAutocross_stopAutocrossFromSW
;d_operating_modes.c,173 :: 		}
...
;d_operating_modes.c,223 :: 		void d_DashboardSetting_updateValue(IntegerIndicator* ind, int val) {
;d_operating_modes.c,224 :: 		ind->value = val;
	PUSH	W11
	ADD	W10, #20, W0
	MOV	W11, [W0]
;d_operating_modes.c,225 :: 		strcpy(ind->base.label, dd_carParameters[ind->value]->name);
	ADD	W10, #20, W0
	MOV	[W0], W0
	SL	W0, #1, W1
	...
	CALL	_strcpy
	POP	W10
;d_operating_modes.c,226 :: 		ind->base.labelLength = dd_carParameters[ind->value]->nameLength;
	ADD	W10, #9, W2
	ADD	W10, #20, W0
	MOV	[W0], W0
	SL	W0, #1, W1
	...
	ADD	W0, #6, W0
	MOV.B	[W0], [W2]
;d_operating_modes.c,227 :: 		ind->base.pendingPrintUpdate = TRUE;
	ADD	W10, #8, W1
	MOV.B	[W1], W0
	XOR.B	W0, #1, W0
	AND.B	W0, #3, W0
...
;d_operating_modes.c,230 :: 		void d_UI_SettingsModeInit() {
;d_operating_modes.c,233 :: 		d_DashboardSetting_updateValue(&sett_dash_top_left, TOP_LEFT);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,234 :: 		d_DashboardSetting_updateValue(&sett_dash_top_right, TOP_RIGHT);
	MOV	#1, W11
	MOV	#lo_addr(_sett_dash_top_right), W10
	CALL	_d_DashboardSetting_updateValue
;d_operating_modes.c,235 :: 		d_DashboardSetting_updateValue(&sett_dash_bottom_right, BOTTOM_RIGHT);
	MOV	#2, W11
	MOV	#lo_addr(_sett_dash_bottom_right), W10
	CALL	_d_DashboardSetting_updateValue
;d_operating_modes.c,236 :: 		d_DashboardSetting_updateValue(&sett_dash_bottom_left, BOTTOM_LEFT);
	MOV	#3, W11
	MOV	#lo_addr(_sett_dash_bottom_left), W10
	CALL	_d_DashboardSetting_updateValue
;d_operating_modes.c,238 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_settings, dd_settingsCount, "Settings");
	MOV	#lo_addr(?lstr90_d_operating_modes), W13
	MOV.B	#6, W12
...
;d_operating_modes.c,245 :: 		void d_UI_onSettingsChange(signed char movements) {
;d_operating_modes.c,248 :: 		Indicator* settingIndicator = dd_settings[dd_Menu_selectedLine()];
	PUSH	W10
	PUSH	W11
	PUSH	W10
	...
	MOV	[W0], W0
	MOV	W0, [W14+0]
;d_operating_modes.c,250 :: 		switch (settingIndicator->id) {
	MOV	W0, [W14+4]
	GOTO	L_d_UI_onSettingsChange0
;d_operating_modes.c,251 :: 		case S_INVERT_COLORS:
L_d_UI_onSettingsChange2:
;d_operating_modes.c,252 :: 		dd_GraphicController_invertColors();
	CALL	_dd_GraphicController_invertColors
;d_operating_modes.c,253 :: 		dd_Indicator_switchBoolValueP(&sett_invert_colors.base);
...
;d_operating_modes.c,254 :: 		settingIndicator->pendingPrintUpdate = TRUE;
	...
	XOR.B	W0, [W1], W0
	MOV.B	W0, [W1]
;d_operating_modes.c,255 :: 		return;
	GOTO	L_end_d_UI_onSettingsChange
;d_operating_modes.c,256 :: 		case S_BYPASS_GEARS:
L_d_UI_onSettingsChange3:
;d_operating_modes.c,257 :: 		if (dGear_isShiftingCheckBypassed()) {
...
;d_operating_modes.c,258 :: 		dGear_enableShiftCheck();
	CALL	_dGear_enableShiftCheck
;d_operating_modes.c,259 :: 		dd_Indicator_setBoolValueP(&sett_bypass_gears.base, FALSE);
	CLR	W11
...
;d_operating_modes.c,260 :: 		settingIndicator->pendingPrintUpdate = TRUE;
	...
	XOR.B	W0, [W1], W0
	MOV.B	W0, [W1]
;d_operating_modes.c,261 :: 		} else {
	GOTO	L_d_UI_onSettingsChange5
L_d_UI_onSettingsChange4:
;d_operating_modes.c,262 :: 		dGear_disableShiftCheck();
	CALL	_dGear_disableShiftCheck
;d_operating_modes.c,263 :: 		dd_Indicator_setBoolValueP(&sett_bypass_gears.base, TRUE);
	MOV.B	#1, W11
	MOV	#lo_addr(_sett_bypass_gears), W10
	CALL	_dd_Indicator_setBoolValueP
;d_operating_modes.c,264 :: 		settingIndicator->pendingPrintUpdate = TRUE;
	MOV	[W14+0], W0
	ADD	W0, #8, W1
	MOV.B	[W1], W0
	XOR.B	W0, #1, W0
...
;d_operating_modes.c,266 :: 		return;
	GOTO	L_end_d_UI_onSettingsChange
;d_operating_modes.c,267 :: 		default:
L_d_UI_onSettingsChange6:
;d_operating_modes.c,268 :: 		break;
...
;d_operating_modes.c,276 :: 		dashboardIndicatorIndex = ((IntegerIndicator*)settingIndicator)->value;
	MOV	[W14+0], W0
	ADD	W0, #20, W0
; dashboardIndicatorIndex start address is: 8 (W4)
	MOV	[W0], W4
;d_operating_modes.c,277 :: 		if (movements) {
	CP0.B	W10
	BRA NZ	L__d_UI_onSettingsChange33
	GOTO	L__d_UI_onSettingsChange16
L__d_UI_onSettingsChange33:
;d_operating_modes.c,278 :: 		dashboardIndicatorIndex+=movements;
	SE	W10, W0
	ADD	W4, W0, W0
...
;d_operating_modes.c,282 :: 		else if (dashboardIndicatorIndex < 0) {
; dashboardIndicatorIndex start address is: 2 (W1)
	CP	W1, #0
