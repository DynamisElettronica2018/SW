...
;d_operating_modes.c,114 :: 		void d_UI_CruiseModeInit() {
;d_operating_modes.c,116 :: 		dd_GraphicController_setCollectionInterface(DASHBOARD_INTERFACE, dd_carParameters, dd_carParametersCount, "Drive");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,119 :: 		void d_UI_AccModeInit(){
;d_operating_modes.c,120 :: 		dd_GraphicController_setCollectionInterface(DASHBOARD_INTERFACE, dd_carParameters, dd_carParametersCount, "Acceleration ");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,123 :: 		void d_UI_DebugModeInit() {
;d_operating_modes.c,124 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_carParameters, dd_carParametersCount, "Debug");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,127 :: 		void d_UI_BoardDebugModeInit() {
;d_operating_modes.c,128 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_carBoards, dd_carBoardsCount, "Boards");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,181 :: 		void d_DashboardSetting_updateValue(IntegerIndicator* ind, int val) {
...
;d_operating_modes.c,192 :: 		void d_UI_SettingsModeInit() {
;d_operating_modes.c,196 :: 		d_DashboardSetting_updateValue(&sett_dash_top_left, TOP_LEFT);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,197 :: 		d_DashboardSetting_updateValue(&sett_dash_top_right, TOP_RIGHT);
	MOV	#1, W11
	MOV	#lo_addr(_sett_dash_top_right), W10
	CALL	_d_DashboardSetting_updateValue
;d_operating_modes.c,198 :: 		d_DashboardSetting_updateValue(&sett_dash_bottom_right, BOTTOM_RIGHT);
	MOV	#2, W11
	MOV	#lo_addr(_sett_dash_bottom_right), W10
	CALL	_d_DashboardSetting_updateValue
;d_operating_modes.c,199 :: 		d_DashboardSetting_updateValue(&sett_dash_bottom_left, BOTTOM_LEFT);
	MOV	#3, W11
	MOV	#lo_addr(_sett_dash_bottom_left), W10
	CALL	_d_DashboardSetting_updateValue
;d_operating_modes.c,201 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_settings, dd_settingsCount, "Settings");
	MOV	#lo_addr(?lstr81_d_operating_modes), W13
	MOV.B	#6, W12
	MOV	#lo_addr(_dd_settings), W11
	MOV.B	#1, W10
	CALL	_dd_GraphicController_setCollectionInterface
;d_operating_modes.c,202 :: 		}
...
;d_operating_modes.c,208 :: 		void d_UI_onSettingsChange(signed char movements) {
;d_operating_modes.c,211 :: 		Indicator* settingIndicator = dd_settings[dd_Menu_selectedLine()];
	PUSH	W10
	PUSH	W11
	PUSH	W10
	...
	MOV	[W0], W0
	MOV	W0, [W14+0]
;d_operating_modes.c,214 :: 		switch (settingIndicator->id) {
	MOV	W0, [W14+4]
	GOTO	L_d_UI_onSettingsChange0
;d_operating_modes.c,215 :: 		case S_INVERT_COLORS:
L_d_UI_onSettingsChange2:
;d_operating_modes.c,216 :: 		dd_GraphicController_invertColors();
	CALL	_dd_GraphicController_invertColors
;d_operating_modes.c,217 :: 		dd_Indicator_switchBoolValueP(&sett_invert_colors.base);
...
;d_operating_modes.c,218 :: 		settingIndicator->pendingPrintUpdate = TRUE;
	...
	XOR.B	W0, [W1], W0
	MOV.B	W0, [W1]
;d_operating_modes.c,219 :: 		return;
	GOTO	L_end_d_UI_onSettingsChange
;d_operating_modes.c,220 :: 		case S_BYPASS_GEARS:
L_d_UI_onSettingsChange3:
;d_operating_modes.c,221 :: 		if (dGear_isShiftingCheckBypassed()) {
...
;d_operating_modes.c,222 :: 		dGear_enableShiftCheck();
	CALL	_dGear_enableShiftCheck
;d_operating_modes.c,223 :: 		dd_Indicator_setBoolValueP(&sett_bypass_gears.base, FALSE);
	CLR	W11
...
;d_operating_modes.c,224 :: 		settingIndicator->pendingPrintUpdate = TRUE;
	...
	XOR.B	W0, [W1], W0
	MOV.B	W0, [W1]
;d_operating_modes.c,225 :: 		} else {
	GOTO	L_d_UI_onSettingsChange5
L_d_UI_onSettingsChange4:
;d_operating_modes.c,226 :: 		dGear_disableShiftCheck();
	CALL	_dGear_disableShiftCheck
;d_operating_modes.c,227 :: 		dd_Indicator_setBoolValueP(&sett_bypass_gears.base, TRUE);
	MOV.B	#1, W11
	MOV	#lo_addr(_sett_bypass_gears), W10
	CALL	_dd_Indicator_setBoolValueP
;d_operating_modes.c,228 :: 		settingIndicator->pendingPrintUpdate = TRUE;
	MOV	[W14+0], W0
	ADD	W0, #8, W1
	MOV.B	[W1], W0
	XOR.B	W0, #1, W0
...
;d_operating_modes.c,230 :: 		return;
	GOTO	L_end_d_UI_onSettingsChange
;d_operating_modes.c,231 :: 		default:
L_d_UI_onSettingsChange6:
;d_operating_modes.c,232 :: 		break;
...
;d_operating_modes.c,241 :: 		dashboardIndicatorIndex = ((IntegerIndicator*)settingIndicator)->value;
	MOV	[W14+0], W0
	ADD	W0, #20, W0
; dashboardIndicatorIndex start address is: 8 (W4)
	MOV	[W0], W4
;d_operating_modes.c,244 :: 		if (movements) {
	CP0.B	W10
	BRA NZ	L__d_UI_onSettingsChange27
	GOTO	L__d_UI_onSettingsChange16
L__d_UI_onSettingsChange27:
;d_operating_modes.c,245 :: 		dashboardIndicatorIndex+=movements;
	SE	W10, W0
	ADD	W4, W0, W0
; dashboardIndicatorIndex end address is: 8 (W4)
; dashboardIndicatorIndex start address is: 2 (W1)
	MOV	W0, W1
;d_operating_modes.c,246 :: 		if (dashboardIndicatorIndex >= dd_carParametersCount) {
	CP	W0, #19
	BRA GE	L__d_UI_onSettingsChange28
	GOTO	L_d_UI_onSettingsChange8
L__d_UI_onSettingsChange28:
;d_operating_modes.c,247 :: 		dashboardIndicatorIndex -= dd_carParametersCount;
...
;d_operating_modes.c,249 :: 		else if (dashboardIndicatorIndex < 0) {
; dashboardIndicatorIndex start address is: 2 (W1)
	CP	W1, #0
	BRA LT	L__d_UI_onSettingsChange29
	GOTO	L__d_UI_onSettingsChange15
L__d_UI_onSettingsChange29:
;d_operating_modes.c,250 :: 		dashboardIndicatorIndex += dd_carParametersCount;
; dashboardIndicatorIndex start address is: 0 (W0)
	ADD	W1, #19, W0
; dashboardIndicatorIndex end address is: 2 (W1)
; dashboardIndicatorIndex end address is: 0 (W0)
;d_operating_modes.c,251 :: 		}
...
;d_operating_modes.c,256 :: 		d_DashboardSetting_updateValue((IntegerIndicator*)settingIndicator, dashboardIndicatorIndex);
; dashboardIndicatorIndex start address is: 0 (W0)
	MOV	W0, W11
; dashboardIndicatorIndex end address is: 0 (W0)
	MOV	[W14+0], W10
...
;d_operating_modes.c,267 :: 		void d_UI_ApplySettings() {
;d_operating_modes.c,271 :: 		for (i=0; i<dd_dashboardSettingsCount; i++) {
...
;d_operating_modes.c,272 :: 		setting = (IntegerIndicator*)dd_dashboardSettings[i];
	ZE	W3, W0
	SL	W0, #1, W2
...
; setting start address is: 8 (W4)
	MOV	[W1], W4
;d_operating_modes.c,273 :: 		oldIndicator = dd_carParameters[i];
	MOV	#lo_addr(d_operating_modes_dd_carParameters), W0
	ADD	W0, W2, W2
; oldIndicator start address is: 10 (W5)
	MOV	[W2], W5
;d_operating_modes.c,274 :: 		dd_carParameters[i] = dd_carParameters[setting->value];
	MOV	[W1], W0
	ADD	W0, #20, W0
	MOV	[W0], W0
	SL	W0, #1, W1
	...
	ADD	W0, W1, W0
	MOV	[W0], [W2]
;d_operating_modes.c,275 :: 		dd_carParameters[setting->value] = oldIndicator;
	ADD	W4, #20, W0
...
;d_operating_modes.c,277 :: 		if (dd_GraphicController_isColorInversionQueued){
...
;d_operating_modes.c,282 :: 		void d_UI_SettingsModeClose() {
;d_operating_modes.c,283 :: 		d_UI_ApplySettings();
