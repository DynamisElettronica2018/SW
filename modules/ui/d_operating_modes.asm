...
;d_operating_modes.c,130 :: 		dd_GraphicController_setCollectionInterface(DASHBOARD_INTERFACE, dd_carParameters, dd_carParametersCount, "Acceleration");
	...
	CLR	W10
	CALL	_dd_GraphicController_setCollectionInterface
;d_operating_modes.c,131 :: 		Debug_UART_Write("Acceleration start prompt set.\r\n");
	MOV	#lo_addr(?lstr68_d_operating_modes), W10
	CALL	_Debug_UART_Write
;d_operating_modes.c,132 :: 		}
...
;d_operating_modes.c,134 :: 		void d_UI_DebugModeInit() {
;d_operating_modes.c,135 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_carParameters, dd_carParametersCount, "Debug");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,138 :: 		void d_UI_BoardDebugModeInit() {
;d_operating_modes.c,139 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_carBoards, dd_carBoardsCount, "Boards");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,142 :: 		void d_UI_CruiseModeClose()
...
;d_operating_modes.c,146 :: 		void d_UI_AccModeClose()
;d_operating_modes.c,148 :: 		dAcc_stopAutoAcceleration();
	PUSH	W10
	CALL	_dAcc_stopAutoAcceleration
;d_operating_modes.c,149 :: 		Debug_UART_Write("Stopped acceleration by mode switch.\r\n");
	MOV	#lo_addr(?lstr71_d_operating_modes), W10
	CALL	_Debug_UART_Write
...
;d_operating_modes.c,229 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_settings, dd_settingsCount, "Settings");
	MOV	#lo_addr(?lstr84_d_operating_modes), W13
	MOV.B	#6, W12
