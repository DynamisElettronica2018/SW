...
;d_operating_modes.c,132 :: 		void d_UI_CruiseModeInit() {
;d_operating_modes.c,133 :: 		dd_GraphicController_setCollectionInterface(DASHBOARD_INTERFACE, dd_carParameters, dd_carParametersCount, "Race");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,136 :: 		void d_UI_AccModeInit(){
;d_operating_modes.c,137 :: 		Debug_UART_Write("Acceleration mode entered.\r\n");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,138 :: 		dd_GraphicController_setCollectionInterface(DASHBOARD_INTERFACE, dd_carParameters, dd_carParametersCount, "Acceleration");
	MOV	#lo_addr(?lstr71_d_operating_modes), W13
	MOV.B	#21, W12
	MOV	#lo_addr(d_operating_modes_dd_carParameters), W11
	CLR	W10
	CALL	_dd_GraphicController_setCollectionInterface
;d_operating_modes.c,139 :: 		Debug_UART_Write("Acceleration start prompt set.\r\n");
	MOV	#lo_addr(?lstr72_d_operating_modes), W10
	CALL	_Debug_UART_Write
;d_operating_modes.c,140 :: 		}
...
;d_operating_modes.c,142 :: 		void d_UI_DebugModeInit() {
;d_operating_modes.c,143 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_carParameters, dd_carParametersCount, "Debug");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,146 :: 		void d_UI_BoardDebugModeInit() {
;d_operating_modes.c,147 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_carBoards, dd_carBoardsCount, "Boards");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,150 :: 		void d_UI_AutocrossModeInit() {
;d_operating_modes.c,151 :: 		dd_GraphicController_setCollectionInterface(DASHBOARD_INTERFACE, dd_carParameters, dd_carParametersCount, "Autocross");
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,155 :: 		void d_UI_CruiseModeClose(){
...
;d_operating_modes.c,158 :: 		void d_UI_AccModeClose(){
;d_operating_modes.c,159 :: 		dAcc_stopAutoAccelerationFromSW();
...
;d_operating_modes.c,162 :: 		void d_UI_DebugModeClose(){
;d_operating_modes.c,163 :: 		}
...
;d_operating_modes.c,165 :: 		void d_UI_BoardDebugModeClose(){
;d_operating_modes.c,166 :: 		}
...
;d_operating_modes.c,168 :: 		void d_UI_AutocrossModeClose(){
;d_operating_modes.c,169 :: 		dAutocross_stopAutocrossFromSW();
	CALL	_dAutocross_stopAutocrossFromSW
;d_operating_modes.c,170 :: 		}
...
;d_operating_modes.c,220 :: 		void d_DashboardSetting_updateValue(IntegerIndicator* ind, int val) {
;d_operating_modes.c,221 :: 		ind->value = val;
	PUSH	W11
	ADD	W10, #20, W0
	MOV	W11, [W0]
;d_operating_modes.c,222 :: 		strcpy(ind->base.label, dd_carParameters[ind->value]->name);
	ADD	W10, #20, W0
	MOV	[W0], W0
	SL	W0, #1, W1
	...
	CALL	_strcpy
	POP	W10
;d_operating_modes.c,223 :: 		ind->base.labelLength = dd_carParameters[ind->value]->nameLength;
	ADD	W10, #9, W2
	ADD	W10, #20, W0
	MOV	[W0], W0
	SL	W0, #1, W1
	...
	ADD	W0, #6, W0
	MOV.B	[W0], [W2]
;d_operating_modes.c,224 :: 		ind->base.pendingPrintUpdate = TRUE;
	ADD	W10, #8, W1
	MOV.B	[W1], W0
	XOR.B	W0, #1, W0
	AND.B	W0, #3, W0
...
;d_operating_modes.c,227 :: 		void d_UI_SettingsModeInit() {
;d_operating_modes.c,230 :: 		d_DashboardSetting_updateValue(&sett_dash_top_left, TOP_LEFT);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
...
;d_operating_modes.c,231 :: 		d_DashboardSetting_updateValue(&sett_dash_top_right, TOP_RIGHT);
	MOV	#1, W11
	MOV	#lo_addr(_sett_dash_top_right), W10
	CALL	_d_DashboardSetting_updateValue
;d_operating_modes.c,232 :: 		d_DashboardSetting_updateValue(&sett_dash_bottom_right, BOTTOM_RIGHT);
	MOV	#2, W11
	MOV	#lo_addr(_sett_dash_bottom_right), W10
	CALL	_d_DashboardSetting_updateValue
;d_operating_modes.c,233 :: 		d_DashboardSetting_updateValue(&sett_dash_bottom_left, BOTTOM_LEFT);
	MOV	#3, W11
	MOV	#lo_addr(_sett_dash_bottom_left), W10
	CALL	_d_DashboardSetting_updateValue
;d_operating_modes.c,235 :: 		dd_GraphicController_setCollectionInterface(MENU_INTERFACE, dd_settings, dd_settingsCount, "Settings");
	MOV	#lo_addr(?lstr88_d_operating_modes), W13
	MOV.B	#6, W12
...
;d_operating_modes.c,242 :: 		void d_UI_onSettingsChange(signed char movements) {
;d_operating_modes.c,245 :: 		Indicator* settingIndicator = dd_settings[dd_Menu_selectedLine()];
	PUSH	W10
	PUSH	W11
	PUSH	W10
	...
	MOV	[W0], W0
	MOV	W0, [W14+0]
;d_operating_modes.c,247 :: 		switch (settingIndicator->id) {
	MOV	W0, [W14+4]
	GOTO	L_d_UI_onSettingsChange0
;d_operating_modes.c,248 :: 		case S_INVERT_COLORS:
L_d_UI_onSettingsChange2:
;d_operating_modes.c,249 :: 		dd_GraphicController_invertColors();
	CALL	_dd_GraphicController_invertColors
;d_operating_modes.c,250 :: 		dd_Indicator_switchBoolValueP(&sett_invert_colors.base);
	MOV	#lo_addr(_sett_invert_colors), W10
	CALL	_dd_Indicator_switchBoolValueP
;d_operating_modes.c,251 :: 		settingIndicator->pendingPrintUpdate = TRUE;
	MOV	[W14+0], W0
	ADD	W0, #8, W1
	MOV.B	[W1], W0
	XOR.B	W0, #1, W0
	...
	XOR.B	W0, [W1], W0
	MOV.B	W0, [W1]
;d_operating_modes.c,252 :: 		return;
	GOTO	L_end_d_UI_onSettingsChange
;d_operating_modes.c,253 :: 		case S_BYPASS_GEARS:
L_d_UI_onSettingsChange3:
;d_operating_modes.c,254 :: 		if (dGear_isShiftingCheckBypassed()) {
...
;d_operating_modes.c,255 :: 		dGear_enableShiftCheck();
	CALL	_dGear_enableShiftCheck
;d_operating_modes.c,256 :: 		dd_Indicator_setBoolValueP(&sett_bypass_gears.base, FALSE);
	CLR	W11
	MOV	#lo_addr(_sett_bypass_gears), W10
	CALL	_dd_Indicator_setBoolValueP
;d_operating_modes.c,257 :: 		settingIndicator->pendingPrintUpdate = TRUE;
	MOV	[W14+0], W0
	ADD	W0, #8, W1
	MOV.B	[W1], W0
	XOR.B	W0, #1, W0
	...
	XOR.B	W0, [W1], W0
	MOV.B	W0, [W1]
;d_operating_modes.c,258 :: 		} else {
	GOTO	L_d_UI_onSettingsChange5
L_d_UI_onSettingsChange4:
;d_operating_modes.c,259 :: 		dGear_disableShiftCheck();
	CALL	_dGear_disableShiftCheck
;d_operating_modes.c,260 :: 		dd_Indicator_setBoolValueP(&sett_bypass_gears.base, TRUE);
	MOV.B	#1, W11
	MOV	#lo_addr(_sett_bypass_gears), W10
	CALL	_dd_Indicator_setBoolValueP
;d_operating_modes.c,261 :: 		settingIndicator->pendingPrintUpdate = TRUE;
	MOV	[W14+0], W0
	ADD	W0, #8, W1
	MOV.B	[W1], W0
	XOR.B	W0, #1, W0
...
;d_operating_modes.c,263 :: 		return;
	GOTO	L_end_d_UI_onSettingsChange
;d_operating_modes.c,264 :: 		default:
L_d_UI_onSettingsChange6:
;d_operating_modes.c,265 :: 		break;
...
;d_operating_modes.c,273 :: 		dashboardIndicatorIndex = ((IntegerIndicator*)settingIndicator)->value;
	MOV	[W14+0], W0
	ADD	W0, #20, W0
...
;d_operating_modes.c,283 :: 		d_DashboardSetting_updateValue((IntegerIndicator*)settingIndicator, dashboardIndicatorIndex);
; dashboardIndicatorIndex start address is: 0 (W0)
	MOV	W0, W11
; dashboardIndicatorIndex end address is: 0 (W0)
	MOV	[W14+0], W10
...
;d_operating_modes.c,294 :: 		void d_UI_ApplySettings() {
;d_operating_modes.c,298 :: 		for (i=0; i<dd_dashboardSettingsCount; i++) {
...
;d_operating_modes.c,299 :: 		setting = (IntegerIndicator*)dd_dashboardSettings[i];
	ZE	W3, W0
	SL	W0, #1, W2
...
; setting start address is: 8 (W4)
	MOV	[W1], W4
;d_operating_modes.c,300 :: 		oldIndicator = dd_carParameters[i];
	MOV	#lo_addr(d_operating_modes_dd_carParameters), W0
	ADD	W0, W2, W2
; oldIndicator start address is: 10 (W5)
	MOV	[W2], W5
;d_operating_modes.c,301 :: 		dd_carParameters[i] = dd_carParameters[setting->value];
	MOV	[W1], W0
	ADD	W0, #20, W0
	MOV	[W0], W0
	SL	W0, #1, W1
	...
	ADD	W0, W1, W0
	MOV	[W0], [W2]
;d_operating_modes.c,302 :: 		dd_carParameters[setting->value] = oldIndicator;
	ADD	W4, #20, W0
...
;d_operating_modes.c,298 :: 		for (i=0; i<dd_dashboardSettingsCount; i++) {
	INC.B	W3
;d_operating_modes.c,303 :: 		}
; i end address is: 6 (W3)
	GOTO	L_d_UI_ApplySettings11
L_d_UI_ApplySettings12:
;d_operating_modes.c,304 :: 		if (dd_GraphicController_isColorInversionQueued){
...
;d_operating_modes.c,309 :: 		void d_UI_SettingsModeClose() {
;d_operating_modes.c,310 :: 		d_UI_ApplySettings();
