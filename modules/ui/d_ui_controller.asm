...
;d_ui_controller.c,43 :: 		Debug_UART_Write("graphic controller initialized.\r\n");
	...
	CALL	_Debug_UART_Write
;d_ui_controller.c,44 :: 		dAcc_init();
	CALL	_dAcc_init
;d_ui_controller.c,45 :: 		Debug_UART_Write("Acceleration module initialized.\r\n");
	MOV	#lo_addr(?lstr8_d_ui_controller), W10
	CALL	_Debug_UART_Write
;d_ui_controller.c,46 :: 		setTimer(TIMER2_DEVICE, TIMER_2_PERIOD);
	MOV	#4719, W11
	MOV	#14979, W12
	MOV.B	#2, W10
	CALL	_setTimer
;d_ui_controller.c,47 :: 		Debug_UART_Write("graphic controller initialized.\r\n");
...
;d_ui_controller.c,51 :: 		d_OperatingMode_close[d_currentOperatingMode]();
	...
	CALL	W0
	POP	W10
;d_ui_controller.c,52 :: 		d_currentOperatingMode = mode;
	MOV	#lo_addr(_d_currentOperatingMode), W0
	MOV.B	W10, [W0]
;d_ui_controller.c,53 :: 		d_OperatingMode_init[mode]();
	ZE	W10, W0
	SL	W0, #1, W1
...
;d_ui_controller.c,56 :: 		OperatingMode d_UI_getOperatingMode(){
;d_ui_controller.c,57 :: 		return d_currentOperatingMode;
	MOV	#lo_addr(_d_currentOperatingMode), W0
	MOV.B	[W0], W0
;d_ui_controller.c,58 :: 		}
...
;d_ui_controller.c,63 :: 		dd_GraphicController_onTimerInterrupt();
	CALL	_dd_GraphicController_onTimerInterrupt
;d_ui_controller.c,64 :: 		}
...
;d_ui_controller.c,70 :: 		void d_controls_onLeftEncoder(signed char movements) {
;d_ui_controller.c,71 :: 		switch (d_currentOperatingMode) {
	GOTO	L_d_controls_onLeftEncoder0
;d_ui_controller.c,72 :: 		case SETTINGS_MODE:
L_d_controls_onLeftEncoder2:
;d_ui_controller.c,73 :: 		case BOARD_DEBUG_MODE:
L_d_controls_onLeftEncoder3:
;d_ui_controller.c,74 :: 		case DEBUG_MODE:
L_d_controls_onLeftEncoder4:
;d_ui_controller.c,75 :: 		dd_Menu_moveSelection(movements);
	CALL	_dd_Menu_moveSelection
;d_ui_controller.c,76 :: 		break;
	GOTO	L_d_controls_onLeftEncoder1
;d_ui_controller.c,77 :: 		case AUTOCROSS_MODE:
L_d_controls_onLeftEncoder5:
;d_ui_controller.c,78 :: 		case CRUISE_MODE:
L_d_controls_onLeftEncoder6:
;d_ui_controller.c,80 :: 		case ACC_MODE:
L_d_controls_onLeftEncoder7:
;d_ui_controller.c,81 :: 		break;
	GOTO	L_d_controls_onLeftEncoder1
;d_ui_controller.c,82 :: 		default:
L_d_controls_onLeftEncoder8:
;d_ui_controller.c,83 :: 		return;
	GOTO	L_end_d_controls_onLeftEncoder
;d_ui_controller.c,84 :: 		}
...
;d_ui_controller.c,87 :: 		void d_controls_onRightEncoder(signed char movements) {
;d_ui_controller.c,88 :: 		switch (d_currentOperatingMode) {
	GOTO	L_d_controls_onRightEncoder9
;d_ui_controller.c,89 :: 		case SETTINGS_MODE:
L_d_controls_onRightEncoder11:
;d_ui_controller.c,90 :: 		d_UI_onSettingsChange(movements);
	CALL	_d_UI_onSettingsChange
;d_ui_controller.c,91 :: 		break;
	GOTO	L_d_controls_onRightEncoder10
;d_ui_controller.c,92 :: 		case BOARD_DEBUG_MODE:
L_d_controls_onRightEncoder12:
;d_ui_controller.c,93 :: 		case DEBUG_MODE:
L_d_controls_onRightEncoder13:
;d_ui_controller.c,94 :: 		case ACC_MODE:
L_d_controls_onRightEncoder14:
;d_ui_controller.c,95 :: 		break;
	GOTO	L_d_controls_onRightEncoder10
;d_ui_controller.c,96 :: 		case AUTOCROSS_MODE:
L_d_controls_onRightEncoder15:
;d_ui_controller.c,97 :: 		case CRUISE_MODE:
L_d_controls_onRightEncoder16:
;d_ui_controller.c,99 :: 		break;
	GOTO	L_d_controls_onRightEncoder10
;d_ui_controller.c,100 :: 		default:
L_d_controls_onRightEncoder17:
;d_ui_controller.c,101 :: 		return;
	GOTO	L_end_d_controls_onRightEncoder
;d_ui_controller.c,102 :: 		}
...
;d_ui_controller.c,105 :: 		OperatingMode d_selectorPositionToMode(signed char position){
;d_ui_controller.c,106 :: 		if (position > FIRST_MODE_POSITION || position < LAST_MODE_POSITION )
	CP.B	W10, #2
...
;d_ui_controller.c,107 :: 		position = CRUISE_MODE_POSITION;
	CLR	W10
L_d_selectorPositionToMode20:
;d_ui_controller.c,108 :: 		return position-LEFTMOST_OPMODE_POSITION;
	SE	W10, W1
	MOV	#65533, W0
	SUB	W1, W0, W0
...
;d_ui_controller.c,113 :: 		void d_controls_onSelectorSwitched(signed char position) {
;d_ui_controller.c,114 :: 		d_UI_setOperatingMode(d_selectorPositionToMode(position));
	PUSH	W10
