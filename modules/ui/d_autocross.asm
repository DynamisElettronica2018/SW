...
;d_autocross.c,61 :: 		if(d_UI_getOperatingMode() == AUTOCROSS_MODE){
	PUSH	W10
...
;d_autocross.c,62 :: 		if(value == COMMAND_START_AUTOCROSS){
	CP	W10, #1
	BRA Z	L__dAutocross_feedbackGCU23
	GOTO	L_dAutocross_feedbackGCU2
L__dAutocross_feedbackGCU23:
;d_autocross.c,63 :: 		dAutocross_GCUConfirmed = COMMAND_START_AUTOCROSS;
	MOV	#1, W0
	MOV	W0, _dAutocross_GCUConfirmed
;d_autocross.c,64 :: 		} else if (value == COMMAND_AUTOCROSS_START_CLUTCH_RELEASE){
...
;d_autocross.c,65 :: 		dAutocross_GCUConfirmed = COMMAND_AUTOCROSS_START_CLUTCH_RELEASE;
	MOV	#2, W0
	MOV	W0, _dAutocross_GCUConfirmed
;d_autocross.c,66 :: 		} else if (value == COMMAND_STOP_AUTOCROSS){
...
;d_autocross.c,67 :: 		dAutocross_stopAutocross();
