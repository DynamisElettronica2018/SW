...
;d_traction_control.c,18 :: 		case 1:
L_d_traction_control_printNotification2:
;d_traction_control.c,19 :: 		dd_GraphicController_fireTimedNotification(TRACTION_CONTROL_NOTIFICATION_TIME, "TC 1", MESSAGE);
	CLR	W12
...
;d_traction_control.c,21 :: 		case 2:
L_d_traction_control_printNotification3:
;d_traction_control.c,22 :: 		dd_GraphicController_fireTimedNotification(TRACTION_CONTROL_NOTIFICATION_TIME, "TC 2", MESSAGE);
	CLR	W12
...
;d_traction_control.c,23 :: 		break;
	GOTO	L_d_traction_control_printNotification1
;d_traction_control.c,24 :: 		case 3:
L_d_traction_control_printNotification4:
;d_traction_control.c,25 :: 		dd_GraphicController_fireTimedNotification(TRACTION_CONTROL_NOTIFICATION_TIME, "TC 3", MESSAGE);
	CLR	W12
...
;d_traction_control.c,26 :: 		break;
	GOTO	L_d_traction_control_printNotification1
;d_traction_control.c,27 :: 		case 4:
L_d_traction_control_printNotification5:
;d_traction_control.c,28 :: 		dd_GraphicController_fireTimedNotification(TRACTION_CONTROL_NOTIFICATION_TIME, "TC 4", MESSAGE);
	CLR	W12
...
;d_traction_control.c,29 :: 		break;
	GOTO	L_d_traction_control_printNotification1
;d_traction_control.c,30 :: 		case 5:
L_d_traction_control_printNotification6:
;d_traction_control.c,31 :: 		dd_GraphicController_fireTimedNotification(TRACTION_CONTROL_NOTIFICATION_TIME, "TC 5", MESSAGE);
	CLR	W12
...
;d_traction_control.c,32 :: 		break;
	GOTO	L_d_traction_control_printNotification1
;d_traction_control.c,33 :: 		case 6:
L_d_traction_control_printNotification7:
;d_traction_control.c,34 :: 		dd_GraphicController_fireTimedNotification(TRACTION_CONTROL_NOTIFICATION_TIME, "TC 6", MESSAGE);
	CLR	W12
...
;d_traction_control.c,35 :: 		break;
	GOTO	L_d_traction_control_printNotification1
;d_traction_control.c,36 :: 		case 7:
L_d_traction_control_printNotification8:
;d_traction_control.c,37 :: 		dd_GraphicController_fireTimedNotification(TRACTION_CONTROL_NOTIFICATION_TIME, "TC 7", MESSAGE);
	CLR	W12
...
;d_traction_control.c,38 :: 		break;
	GOTO	L_d_traction_control_printNotification1
;d_traction_control.c,39 :: 		case 8:
L_d_traction_control_printNotification9:
;d_traction_control.c,40 :: 		dd_GraphicController_fireTimedNotification(TRACTION_CONTROL_NOTIFICATION_TIME, "TC 8", MESSAGE);
	CLR	W12
...
;d_traction_control.c,41 :: 		break;
	GOTO	L_d_traction_control_printNotification1
;d_traction_control.c,42 :: 		case 9:
L_d_traction_control_printNotification10:
;d_traction_control.c,43 :: 		dd_GraphicController_fireTimedNotification(TRACTION_CONTROL_NOTIFICATION_TIME, "TC 9", MESSAGE);
	CLR	W12
...
;d_traction_control.c,44 :: 		break;
	GOTO	L_d_traction_control_printNotification1
;d_traction_control.c,45 :: 		case 10:
L_d_traction_control_printNotification11:
;d_traction_control.c,46 :: 		dd_GraphicController_fireTimedNotification(TRACTION_CONTROL_NOTIFICATION_TIME, "TC 10", MESSAGE);
	CLR	W12
...
;d_traction_control.c,53 :: 		void d_traction_control_propagateValue(signed char value){
;d_traction_control.c,54 :: 		Can_writeInt(SW_TRACTION_CONTROL_GCU_ID, (int) value);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	SE	W10, W0
...
L_d_traction_control_move13:
	CP.B	W1, #0
	BRA LT	L__d_traction_control_move31
