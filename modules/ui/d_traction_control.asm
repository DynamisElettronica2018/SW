...
;d_traction_control.c,57 :: 		void d_traction_control_setOldValue(void){
;d_traction_control.c,58 :: 		d_traction_control_propagateValue(d_tractionValue);
	PUSH	W10
	MOV	#lo_addr(_d_tractionValue), W0
	MOV.B	[W0], W10
...
;d_traction_control.c,61 :: 		void d_traction_control_propagateValue(signed char value){
;d_traction_control.c,62 :: 		Can_writeInt(SW_TRACTION_CONTROL_GCU_ID, (int) value);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	SE	W10, W0
...
;d_traction_control.c,65 :: 		void d_traction_control_move(signed char movements){
;d_traction_control.c,67 :: 		value = d_tractionValue - movements;
	PUSH	W10
	MOV	#lo_addr(_d_tractionValue), W0
	SE	[W0], W1
	SE	W10, W0
...
; value start address is: 2 (W1)
	MOV.B	W0, W1
;d_traction_control.c,68 :: 		if(value > TRACTION_MAX_VALUE){
	CP.B	W0, #7
	BRA GT	L__d_traction_control_move34
	GOTO	L_d_traction_control_move14
L__d_traction_control_move34:
;d_traction_control.c,69 :: 		value = TRACTION_MAX_VALUE;
	MOV.B	#7, W1
;d_traction_control.c,70 :: 		} else if(value < TRACTION_MIN_VALUE){
...
;d_traction_control.c,71 :: 		value = TRACTION_MIN_VALUE;
...
; value start address is: 2 (W1)
	MOV	#lo_addr(_d_tractionValue), W0
	MOV.B	W1, [W0]
;d_traction_control.c,74 :: 		d_traction_control_propagateValue(d_tractionValue);
	MOV.B	W1, W10
; value end address is: 2 (W1)
	CALL	_d_traction_control_propagateValue
...
;d_traction_control.c,77 :: 		void d_traction_control_setValueFromCAN(unsigned int value){
;d_traction_control.c,78 :: 		if(d_UI_getOperatingMode() != ACC_MODE){
	PUSH	W10
...
;d_traction_control.c,79 :: 		d_tractionValue = value;
	MOV	#lo_addr(_d_tractionValue), W0
	MOV.B	W10, [W0]
;d_traction_control.c,80 :: 		d_traction_control_printNotification();
	CALL	_d_traction_control_printNotification
;d_traction_control.c,81 :: 		}
L_d_traction_control_setValueFromCAN17:
;d_traction_control.c,82 :: 		return;
;d_traction_control.c,83 :: 		}
...
;d_traction_control.c,85 :: 		void d_traction_control_init(void){
